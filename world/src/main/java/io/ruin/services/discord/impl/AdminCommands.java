...
//            eb.setColor(new Color(0xB00D03));
//            eb.addField("Double PC Points!", "Double PC Points are now " + (World.doublePest ? "**ENABLED**" : "**DISABLED**")+"!", false);
//            e.getChannel().sendMessage(eb.build()).queue();
//        }
...
//            eb.setColor(new Color(0xB00D03));
//            eb.addField("Double Slayer Points!", "Double Slayer Points are now " + (World.doubleSlayer ? "**ENABLED**" : "**DISABLED**")+"!", false);
//            e.getChannel().sendMessage(eb.build()).queue();
//        }
