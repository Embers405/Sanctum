...
public final class VarrockAchievementDiary extends StatefulAchievementDiary<VarrockDiaryEntry> {
    ...
    public static final Set<VarrockDiaryEntry> EASY_TASKS = EnumSet.of(THESSALIA_SHOP,TELEPORT_ESSENCE_VAR,MINE_IRON,EARTH_RUNES,MAKE_PLANK, STRONGHOLD, JUMP_FENCE);
    ...
    public boolean hasCompletedAchieve(String difficulty) {
        ...
        switch (difficulty) {
            //EASY
            case "THESSALIA_SHOP":
                return achievements.contains(THESSALIA_SHOP);
    ...
    public final void display() {
        player.sendScroll("<col=8B0000>Varrock Diary",
                ...
                hasCompletedAchieve("THESSALIA_SHOP") ? "<col=24d124>Steal from the Tea Stall.</col>" : "<col=911c25>Steal from the Tea Stall.",
                ...
                hasCompletedAchieve("MAKE_PLANK") ? "<col=24d124>Make a Plank at the Sawmill.</col>" : "<col=911c25>Make a Plank at the Sawmill.",
