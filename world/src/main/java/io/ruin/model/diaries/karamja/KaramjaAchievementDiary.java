...
import static io.ruin.model.diaries.karamja.KaramjaDiaryEntry.*;
...
public final class KaramjaAchievementDiary extends StatefulAchievementDiary<KaramjaDiaryEntry> {
    ...
    public static final Set<KaramjaDiaryEntry> EASY_TASKS = EnumSet.of(MINE_GOLD, TELEPORT_TO_KARAMJA, SAIL_TO_ARDOUGNE, SAIL_TO_PORT_SARIM, ATTEMPT_FIGHT_CAVES);

    public static final Set<KaramjaDiaryEntry> MEDIUM_TASKS = EnumSet.of(DURADEL, CHOP_VINE, TRAVEL_PORT_KHAZARD);

    public static final Set<KaramjaDiaryEntry> HARD_TASKS = EnumSet.of(COMPLETE_FIGHT_CAVES, KILL_KET_ZEK, KILL_METAL_DRAGON);

    public static final Set<KaramjaDiaryEntry> ELITE_TASKS = EnumSet.of(CRAFT_NATURES, ANTI_VENOM, COMPLETE_INFERNO);
