...
public final class WildernessAchievementDiary extends StatefulAchievementDiary<WildernessDiaryEntry> {
    ...
    public static final Set<WildernessDiaryEntry> MEDIUM_TASKS = EnumSet.of(MINE_MITHRIL_WILD, WILDERNESS_GODWARS, WILDERNESS_AGILITY, KILL_GREEN_DRAGON, KILL_ANKOU, KILL_BLOODVELD, EMBLEM_TRADER);
    ...
    public boolean hasCompletedAchieve(String difficulty) {
        ...
        switch (difficulty) {
            ...
            case "EMBLEM_TRADER":
                return achievements.contains(EMBLEM_TRADER);
            //HARD
