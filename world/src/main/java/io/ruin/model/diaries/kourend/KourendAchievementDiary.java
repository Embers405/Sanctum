...
public class KourendAchievementDiary extends StatefulAchievementDiary<KourendDiaryEntry> {
    ...
    public static final Set<KourendDiaryEntry> EASY_TASKS = EnumSet.of(SPELL_BOOK, SPEAK_TO_DEATH, FOUNTAIN, BUY_HOUSE, GE, VOTE_STORE, DONATION_STORE, MITHRIL_SEED);

    public static final Set<KourendDiaryEntry> MEDIUM_TASKS = EnumSet.of(KOUREND_SARIM, CATACOMBS, MOLCH_ISLAND, LOVAKENGJ, KILL_JELLIES, COOK_LOBSTER, KILL_SANDCRAB, CATCH_COPPER);
    ...
    public static final Set<KourendDiaryEntry> ELITE_TASKS = EnumSet.of(CHOP_YEW, CATCH_ANGLER, SOUL_RUNE, KILL_ABYSSAL, KILL_SKOTIZO, KILL_VBOSS, ARCLIGHT, COX);
    ...
    public int getCount(int id) { return player.getInventory().getAmount(id); }
    ...
    public boolean hasCompletedAchieve(String difficulty) {
        ...
        switch (difficulty) {
            ...
            case "MITHRIL_SEED":
                return achievements.contains(MITHRIL_SEED);
            //MEDIUM
            case "KOUREND_SARIM":
                return achievements.contains(KOUREND_SARIM);
            case "CATACOMBS":
            ...
            case "CATCH_ANGLER":
                return achievements.contains(CATCH_ANGLER);
            case "SOUL_RUNE":
            ...
            case "KILL_VBOSS":
                return achievements.contains(KILL_VBOSS);
            case "ARCLIGHT":
    ...
    public final void display() {
        player.sendScroll("<col=8B0000>Kourend & Kebos Diary",
                ...
                hasCompletedAchieve("STEAL_SILVER") ? "<col=24d124>Steal from the Silver Stall. (" +(getAbsoluteAchievementStage(STEAL_SILVER)) + "/" + getMaximum(STEAL_SILVER)+")</col>" : "<col=911c25>Steal from the Silver Stall. (" +(getAbsoluteAchievementStage(STEAL_SILVER)) + "/" + getMaximum(STEAL_SILVER)+ ")",
                ...
                hasCompletedAchieve("KILL_VBOSS") ? "<col=24d124>Kill a Vote Boss.</col>" : "<col=911c25>Kill a Vote Boss.",
