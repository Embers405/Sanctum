...
public enum Potion {
    ...
    DIVINE_SUPER_ATTACK(70,0,"divine super attack potion", "super attack(3)","crystal shard"),
    DIVINE_SUPER_STRENGTH(70,0,"divine super strength potion","super strength(3)","crystal shard"),
    DIVINE_SUPER_DEFENCE(70,0,"divine super defence potion","super defence(3)","crystal shard"),
    DIVINE_RANGING(74,0,"divine ranging potion","ranging potion(3)","crystal shard"),
    DIVINE_MAGIC(74,0,"divine magic potion","magic potion(3)","crystal shard"),
    DIVINE_SUPER_COMBAT(97,0,"divine super combat potion","super combat potion(3)","crystal shard"),
    ...
    static {
        for(Potion potion : values()) {
            ...
            if(potion == DIVINE_SUPER_STRENGTH)
                registerUpgrade(potion, primaryId, secondaryIds[0], 1);
            if(potion == DIVINE_SUPER_DEFENCE)
                registerUpgrade(potion, primaryId, secondaryIds[0], 1);
            if(potion == DIVINE_SUPER_COMBAT)
                registerUpgrade(potion, primaryId, secondaryIds[0], 1);
