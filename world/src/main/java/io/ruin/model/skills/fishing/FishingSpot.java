                    ...
                    if(npc.getId() == MINNOWS && (npc.minnowsFish)) {
                        ...
                        if (c.id == 363) {
                            if (Random.rollDie(5,1)) {
                                player.getInventory().add(353, amount);
                                player.getDiaryManager().getKandarinDiary().progress(KandarinDiaryEntry.CATCH_MACKAREL);
                            } else {
                        ...
                        if (c.id == 13439) {
                            player.getDiaryManager().getKourendDiary().progress(KourendDiaryEntry.CATCH_ANGLER);
                        }
