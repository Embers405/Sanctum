...
public class ShootingStars {
        ...
        if (!DISABLED) {
            ...
            World.startEvent(e -> {
                while (true) {
                    ...
                    Guild guild = DiscordConnection.jda.getGuildById("1175285001382797322"); //Guild you got from a listener, or from the JDA pool
            ...
            ObjectAction.register(STAR_PROGRESS_1, 2, (player, obj) -> Prospect(player));

            ObjectAction.register(STAR_START, 1, (player, obj) -> mine(player));
            ObjectAction.register(STAR_START, 2, (player, obj) -> Prospect(player));

            ObjectAction.register(STAR_PROGRESS_2, 1, (player, obj) -> mine(player));
            ObjectAction.register(STAR_PROGRESS_2, 2, (player, obj) -> Prospect(player));

            ObjectAction.register(STAR_PROGRESS_3, 1, (player, obj) -> mine(player));
            ObjectAction.register(STAR_PROGRESS_3, 2, (player, obj) -> Prospect(player));

            ObjectAction.register(STAR_PROGRESS_4, 1, (player, obj) -> mine(player));
            ObjectAction.register(STAR_PROGRESS_4, 2, (player, obj) -> Prospect(player));

            ObjectAction.register(STAR_PROGRESS_5, 1, (player, obj) -> mine(player));
            ObjectAction.register(STAR_PROGRESS_5, 2, (player, obj) -> Prospect(player));

            ObjectAction.register(STAR_FINISH, 1, (player, obj) -> mine(player));
            ObjectAction.register(STAR_FINISH, 2, (player, obj) -> Prospect(player));
    ...
    private static void Prospect(Player player) {
