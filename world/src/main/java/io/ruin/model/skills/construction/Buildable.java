...
public enum Buildable {
    ...
    * Nexus room
     */
    MARBLE_PORTAL_NEXUS(72, 2000, MID_BUILD, 22705, 33408, MARBLE_BLOCK.item(4)),
    GILDED_PORTAL_NEXUS(82, 2600, MID_BUILD, 22706, 33409, GOLD_LEAF.item(2), MARBLE_BLOCK.item(4)),
    CRYSTALLINE_PORTAL_NEXUS(92, 2600, MID_BUILD, 22707, 33410, MAGIC_STONE.item(2), GOLD_LEAF.item(2)),
