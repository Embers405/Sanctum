...
public enum FishingCatch {
    ...
    SHARK(383, 76, 125.0, 0.3, 20000),
    ANGLERFISH(13439, 82, 145.0, 0.18, 20000),
    DARK_CRAB(11934, 85, 150.0, 0.3, 20000),
    MINNOWS(21356, 82, 26.0, 1.0, 100000),
    INFERNAL_EEL(21293, 80, 95.0, 0.3, 10000),
    SLIMY_EEL(3379, 80, 95.0, 0.3, 10000),
    /**
     * Barbarian
     */
    ...
    HARPOON_FISH(25564, 35, 10, 0.4, 24000)
