...
public class ThroneRoom {
        ...
        for (Trapdoor trapdoor : Trapdoor.values()) {
            ...
            ObjectAction.register(trapdoor.open, "go-down", Construction.forCurrentRoomElse((player, room) -> {
                ...
                if (player.getPosition().getRegion().id == 15148) {
                    player.getMovement().teleport(3810, 2845, 0);
                }
            }));
    ...
    static {
        ObjectDef.get(13681).interactType = 1;
        ObjectDef.get(13681).blocksProjectile = true;
        ObjectDef.get(13682).interactType = 1;
        ObjectDef.get(13682).blocksProjectile = true;
        ObjectDef.get(13683).interactType = 1;
        ObjectDef.get(13683).blocksProjectile = true;
    }
