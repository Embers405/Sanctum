...
public class Salamander extends Creature {
    ...
    static {
        Hunter.registerCreature(new Salamander("swamp lizard", NetTrap.SWAMP, 2906, 10149, 29, 152, 0.7, 20, PlayerCounter.CAUGHT_SWAMP_LIZARD ));
        Hunter.registerCreature(new Salamander("orange salamander", NetTrap.DESERT, 2903, 10146, 47, 224, 0.7, 20, PlayerCounter.CAUGHT_ORANGE_SALAMANDER));
        Hunter.registerCreature(new Salamander("red salamander", NetTrap.RED, 2904, 10147, 59, 272, 0.7, 20, PlayerCounter.CAUGHT_RED_SALAMANDER));
