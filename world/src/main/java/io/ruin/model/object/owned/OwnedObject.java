...
public abstract class OwnedObject extends GameObject {
    ...
    public OwnedObject(Player owner, String identifier, int id, Position pos, int type, int direction) {
        ...
        this.ownerUID = owner.getName();
        this.identifier = identifier;
    }

    public OwnedObject(String ownerUID, String identifier, int id, Position pos, int type, int direction) {
        super(id, pos, type, direction);
    ...
    public boolean isOwner(Player player) {
        return player.getName().equalsIgnoreCase(ownerUID);
    }

    public Player getOwner() {
        return World.getPlayer(ownerUID);
    }

    public Optional<Player> getOwnerOpt() {
        return World.getPlayerByName(ownerUID);
    }
