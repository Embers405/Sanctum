                        ...
                        new Option("Do you sell anything?", () -> player.dialogue(
                                ...
                                new OptionsDialogue("View the Achievement Rewards?",
                                        new Option("Yes", () -> {
                                            ...
                                            if (!player.getDiaryManager().getDesertDiary().hasDoneAll()) {
                                                player.sendMessage("You need to complete the Desert Diary Before you can Access the shop!");
                                                return;
                                            }
                                            ...
                                            if (!player.getDiaryManager().getWildernessDiary().hasDoneAll()) {
                                                player.sendMessage("You need to complete the Wilderness Diary Before you can Access the shop!");
                                                return;
                                            }

                                            ShopManager.openIfExists(player, "TWIGGYLETSGOO");
                                        }),//TODO Fill this in
