...
import io.ruin.model.inter.battlepass.SeasonPassParameters;
...
import io.ruin.services.dupewatch.DupeWarden;
...
public class Player extends PlayerAttributes {
     ...
     * Group IronMan
     **/
    @Expose public long inviteDelay = 1000;
    @Expose public boolean checkGIM = false;
    @Expose public GroupIronman GIM;
    ...
    @Expose @Setter public GIMStorage GIMStorage;
    /**
     * Session
     */
    /**
    ...
    public void setConfClientType(int confClientType) {
        this.confClientType = confClientType;
    }
    ...
    @Expose public String LastipAddress;

    @Expose public int ipAddressInt;
     ...
     * Crystal of memories
     * */
    @Expose public Position lastTeleport;
    ...
    @ Expose private SecondaryGroup secondaryGroup;
    ...
    @Expose public HashMap<String, Integer> DiaryRecorder = new HashMap<>();
    public ArrayList<String> DiaryRewards = new ArrayList<>();

    @Expose public int slayertaskskip = 0;
    @Expose public long slayertasktimer = 0;
    @Expose public long Dslayertasktimer = 0;
    @Expose public int Dslayertask = 0;

    @Expose public int currentSlayerMaster;
    @Expose public String slayerTaskName;
    @Expose public SlayerTask.Type slayerTaskType;
    /**
     * Custom Shop System
     */
    ...
    /** Battle pass*/
    @Expose public BattlePass drakoPass;
    ...
    public boolean isDonator() {
        return isGroups(SecondaryGroup.BRONZE) || isGroups(SecondaryGroup.IRON) || isGroups(SecondaryGroup.GOLD)
                || isGroups(SecondaryGroup.MITHRIL) || isGroups(SecondaryGroup.ADAMANT) || isGroups(SecondaryGroup.RUNE)
                || isGroups(SecondaryGroup.DRAGON);
    }

    public boolean isBronze() {
        return isGroups(SecondaryGroup.BRONZE);
    }

    public boolean isIron() {
        return isGroups(SecondaryGroup.IRON);
    }

    public boolean isGold() {
        return isGroups(SecondaryGroup.GOLD);
    }

    public boolean isMithril() {
        return isGroups(SecondaryGroup.MITHRIL);
    }

    public boolean isAdamant() {
        return isGroups(SecondaryGroup.ADAMANT);
    }

    public boolean isRune() {
        return isGroups(SecondaryGroup.RUNE);
    }

    public boolean isDragon() {
        return isGroups(SecondaryGroup.DRAGON);
    }
    ...
    @Getter @Setter @Expose private Boolean funpkWarning = false;
    @Getter @Setter @Expose private Boolean funpk = false;
...
//        if (GIMRepository.gimData != null) {
            GIMRepository.onlogout(this);
//        }

        if (!World.isDev()) {
            jda.getPresence().setPresence(OnlineStatus.ONLINE, Activity.watching((int) (World.players.count() ) + " players!"));
        }
    }
    ...
    public boolean isPoisonImmune() {
        return super.isPoisonImmune() ||
                ...
                player.pet == Pet.SNAKELING_BLUE || player.pet == Pet.SNAKELING_GREEN || player.pet == Pet.SNAKELING_RED;
    }
...
/*        if (Config.IRONMAN_MODE.get(this) >= 6) {
            return ;
        }*/
