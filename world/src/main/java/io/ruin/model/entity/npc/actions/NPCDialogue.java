...
public class NPCDialogue {
    ...
    static {
        ...
        NPCAction.register(1501, "trade", (player, npc) -> player.dialogue(new io.ruin.model.inter.dialogue.NPCDialogue(npc, "welcome to the hunter shop")));
        ...
        NPCAction.register(2820, "talk-to", (player, npc) -> player.dialogue(new io.ruin.model.inter.dialogue.NPCDialogue(npc,"Welcome to RuneRogue's General Store")));
        NPCAction.register(3200, "talk-to", (player, npc) -> player.dialogue(new io.ruin.model.inter.dialogue.NPCDialogue(npc,"Welcome to RuneRogue's General Store")));
        ...
        NPCAction.register(901,1,(player, npc) -> player.openInterface(InterfaceType.MAIN, 1018));
