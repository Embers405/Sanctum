...
public abstract class PlayerAttributes extends Entity {
    ...
    @Expose @Getter @Setter public Integer FunPkPoints = 0;
    ...
    @Expose public int DropRateBoost = 0;


    @Expose public boolean referral = false;
    @Expose public int TheatreOfBloodCompletions = 0;

    @Expose public int tobDeaths = 0;
    @Expose public int tobDamage = 0;
    @Expose public int raidPoints = 0;
    @Expose public int TOBChests = 0;
    @Expose public int ownerId;
    @Expose public boolean tobcannon = false;
    /**
     *  League points
     */

    @Expose public int totalLeaguePoints;
    @Expose public int twistedLeaguePoints;
    @Expose public int trailblazerLeaguePoints;
    @Expose public int shatteredrelicsLeaguePoints;
    ...
    @Expose public boolean abyssalAccumulatorUnlocked = false;
    @Expose public boolean endlessEnduranceUnlocked = false;
    @Expose public boolean darkAltarDevotionUnlocked = false;

    /**
     * Twisted league tier 2 relics
     */

    @Expose public boolean hardcoreHarvesterUnlocked = false;
    @Expose public boolean arcaneCourierUnlocked = false;
    @Expose public boolean UnnaturalSelectionUnlocked = false;

    /**
     * Twisted league tier 3 relics
     */

    @Expose public boolean eyeOfTheArtisanUnlocked = false;
    @Expose public boolean giftOfTheGathererUnlocked = false;
    @Expose public boolean wayOfTheWarriorUnlocked = false;

    /**
     * Twisted league tier 4 relics
     */

    @Expose public boolean spiritOfDinhUnlocked = false;
    @Expose public boolean konarsBlessingUnlocked = false;
    @Expose public boolean treasureSeekerUnlocked = false;

    /**
     * Twisted league tier 5 relics
     */

    @Expose public boolean xericsFocusUnlocked = false;
    @Expose public boolean xericsResilienceUnlocked = false;
    @Expose public boolean xericsWisdomUnlocked = false;
    ...
    @Expose public boolean endlessHarvestUnlocked = false;
    @Expose public boolean productionMasterUnlocked = false;
    @Expose public boolean skillingProdigyUnlocked = false;

    /**
     * Trailblazer league tier 2 relics
     */

    @Expose public boolean fairysFlightUnlocked = false;
    @Expose public boolean eternalJewellerUnlocked = false;
    @Expose public boolean lastRecallUnlocked = false;

    /**
     * Trailblazer league tier 3 relics
     */

    @Expose public boolean quickShotUnlocked = false;
    @Expose public boolean fluidStrikesUnlocked = false;
    @Expose public boolean doubleCastUnlocked = false;
    ...
    @Expose public boolean theBotanistUnlocked = false;
    @Expose public boolean infernalGatheringUnlocked = false;
    @Expose public boolean EquilibriumUnlocked = false;

    /**
     * Shattered relics
     */

    @Expose public boolean hasUnlockedLumbridgeWaystone = false;
    @Expose public boolean hasUnlockedFaladorWaystone = false;
    @Expose public boolean hasUnlockedVarrockWaystone = false;
    @Expose public boolean hasUnlockedAlKharidWaystone = false;
    @Expose public boolean hasUnlockedCatherbyWaystone = false;
    @Expose public boolean hasUnlockedArdougneWaystone = false;
    @Expose public boolean hasUnlockedBrimhavenWaystone = false;
    @Expose public boolean hasUnlockedRellekkaWaystone = false;
    @Expose public boolean hasUnlockedFeroxEnclaveWaystone = false;
    @Expose public boolean hasUnlockedCanifisWaystone = false;
    @Expose public boolean hasUnlockedPrifddinasWaystone = false;
    @Expose public boolean hasUnlockedKourendWaystone = false;

    /**
     * Inferno sacrfice fire cape
     */

    @Expose public boolean hasSacrificedFireCape = false;

    /**
     * BitCoin
     */
    @Expose public double bitcoins;
    ...
    @Expose public BirdHouseHandler birdHouseHandler;

    /** Quests */
    @Expose public int questPoints = 0;
    @Expose public int completedQuests;
    @Expose public int doricsQuest;
    @Expose public int cooksAssistant;
    @Expose public int dragonslayerTwo;
    @Expose public int monkeyMadness;
    @Expose public int santaQuest;
    @Expose public int sheepShearer;

    /** arena pvp variables */
    @Expose public int conquestPoints;
    @Expose public int arenatwosWins;
    @Expose public int arenathreesWins;
    @Expose public int battlegroundWins;
    @Expose public boolean claimedSeasonReward;
    public BattleGrounds battleGroundsGame;


    /** achivement points */
    @Expose public int achievementPoints;

    /**
     * Reputation
      */
    @Expose public int greendragonRep;
    @Expose public int giantmoleRep;
    @Expose public int goblinRep;
    @Expose public int gnomeTroops;
    @Expose public int shamanRep;
    @Expose public int wyrmRep;

    @Expose public int kingArthurRep;
    @Expose public int sirKayRep;
    @Expose public int pentynRep;
    @Expose public int councillorAndrews;
    @Expose public int kingRoald;
    @Expose public int auburyRep;
    @Expose public int thessaliaRep;
    @Expose public int ellamariaRep;

    @Expose public int flynnRep;
    @Expose public int doormanRep;
    @Expose public int herquinRep;
    @Expose public int wayneRep;

    @Expose public static final int maxDesertRep = 7500;
    @Expose public static final int maxEdgevilleRep = 21000;
    @Expose public static final int maxFaladorRep = 10000;
    @Expose public static final int maxFremennikRep = 6000;
    @Expose  public static final int maxKandarinRep = 5000;
    @Expose public static final int maxKaramjaRep = 5500;
    @Expose public static final int maxKebosRep = 10000;
    @Expose public static final int maxKourendRep = 8500;
    @Expose public static final int maxLumbridgeRep = 7000;
    @Expose public static final int maxMorytaniaRep = 12000;
    @Expose public static final int maxPrifddinasRep = 10000;
    @Expose public static final int maxVarrockRep = 8000;
    @Expose public int desertRep, edgevilleRep, faladorRep, fremennikRep, kandarinRep, karamjaRep, kebosRep, kourendRep, lumbridgeRep, morytaniaRep, prifddinasRep, varrockRep;

    /**
     *  Diaries
     */
    @Expose public int easyArdy = 0;
    @Expose public int medArdy = 0;
    @Expose public int hardArdy = 0;
    @Expose public int eliteArdy = 0;

    @Expose public int desertEasy = 0;
    @Expose public int desertMedium = 0;
    @Expose public int desertHard = 0;
    @Expose public int desertElite = 0;

    @Expose public int faladorEasy = 0;
    @Expose public int faladorMedium = 0;
    @Expose public int faladorHard = 0;
    @Expose public int faladorElite = 0;

    @Expose public int fremennikEasy = 0;
    @Expose public int fremennikMedium = 0;
    @Expose public int fremennikHard = 0;
    @Expose public int fremennikElite = 0;

    @Expose public int kandarinEasy = 0;
    @Expose public int kandarinMedium = 0;
    @Expose public int kandarinHard = 0;
    @Expose public int kandarinElite = 0;

    @Expose public int karamjaEasy = 0;
    @Expose public int karamjaMedium = 0;
    @Expose public int karamjaHard = 0;
    @Expose public int karamjaElite = 0;

    @Expose public int lumbEasy = 0;
    @Expose public int lumbMedium = 0;
    @Expose public int lumbHard = 0;
    @Expose public int lumbElite = 0;

    @Expose public int morytaniaEasy = 0;
    @Expose public int morytaniaMedium = 0;
    @Expose public int morytaniaHard = 0;
    @Expose public int morytaniaElite = 0;

    @Expose public int varrockEasy = 0;
    @Expose public int varrockMedium = 0;
    @Expose public int varrockHard = 0;
    @Expose public int varrockElite = 0;

    @Expose public int westernEasy = 0;
    @Expose public int westernMedium = 0;
    @Expose public int westernHard = 0;
    @Expose public int westernElite = 0;

    @Expose public int wildyEasy = 0;
    @Expose public int wildyMedium = 0;
    @Expose public int wildyHard = 0;
    @Expose public int wildyElite = 0;

    @Expose public int kourendEasy = 0;
    @Expose public int kourendMedium = 0;
    @Expose public int kourendHard = 0;
    @Expose public int kourendElite = 0;

    @Expose public boolean tonel = false;
    @Expose public boolean ttwol = false;
    @Expose public boolean tthreel = false;
    @Expose public boolean tfourl = false;
    @Expose public boolean tfivel = false;
    @Expose public boolean tsixl = false;
    @Expose public boolean tsevenl = false;
    @Expose public boolean teightl = false;
    @Expose public boolean tninel = false;

    @Expose public int tone;
    @Expose public int ttwo;
    @Expose public int tthree;
    @Expose public int tfour;
    @Expose public int tfive;
    @Expose public int tsix;
    @Expose public int tseven;
    @Expose public int teight;
    @Expose public int tnine;

    @Expose public int card = 0;
    ...
    @Expose public boolean hasAcceptedFarmingContract;
    @Expose public boolean hasAcceptedHerbloreContract;
    @Expose public boolean hasAcceptedWoodcuttingContract;
    @Expose public boolean hasAcceptedFiremakingContract;
    @Expose public boolean hasAcceptedFletchingContract;
    @Expose public boolean hasAcceptedMiningContract;
    @Expose public boolean hasAcceptedSmithingContract;
    @Expose public boolean hasAcceptedFishingContract;
    @Expose public boolean hasAcceptedCookingContract;
    @Expose public boolean hasAcceptedSlayerContract;
    @Expose public boolean hasAcceptedAgilityContract;
    @Expose public boolean hasAcceptedHunterContract;
    @Expose public boolean hasAcceptedThievingContract;
    @Expose public boolean hasAcceptedPrayerContract;
    @Expose public boolean hasAcceptedRunecraftingContract;
    @Expose public boolean hasAcceptedConstructionContract;

    /** has completed skilling contracts boolean */
    @Expose public boolean hasCompletedFarmingContract;
    @Expose public boolean hasCompletedHerbloreContract;
    @Expose public boolean hasCompletedWoodcuttingContract;
    @Expose public boolean hasCompletedFiremakingContract;
    @Expose public boolean hasCompletedFletchingContract;
    @Expose public boolean hasCompletedMiningContract;
    @Expose public boolean hasCompletedSmithingContract;
    @Expose public boolean hasCompletedFishingContract;
    @Expose public boolean hasCompletedCookingContract;
    @Expose public boolean hasCompletedSlayerContract;
    @Expose public boolean hasCompletedAgilityContract;
    @Expose public boolean hasCompletedHunterContract;
    @Expose public boolean hasCompletedThievingContract;
    @Expose public boolean hasCompletedPrayerContract;
    @Expose public boolean hasCompletedRunecraftingContract;
    @Expose public boolean hasCompletedConstructionContract;

    /** skilling contract int amount **/
    @Expose public int woodcuttingContractAmount;
    @Expose public int fishingContractAmount;
    @Expose public int miningContractAmount;
    @Expose public int smithingContractAmount;
    @Expose public int fletchingContractAmount;
    @Expose public int firemakingContractAmount;
    @Expose public int herbloreContractAmount;
    @Expose public int farmingContractAmount;
    @Expose public int cookingContractAmount;
    @Expose public int slayerContractAmount;
    @Expose public int agilityContractAmount;
    @Expose public int hunterContractAmount;
    @Expose public int thievingContractAmount;
    @Expose public int prayerContractAmount;
    @Expose public int runecraftingContractAmount;
    @Expose public int constructionContractAmount;

    /** farming contract tier **/
    @Expose @Getter public FarmingContractTier farmingContractTier;


    /** skilling contract types **/
    @Expose @Getter public AgilityContractType agilityContractType;
    @Expose @Getter public FarmingContractType farmingContractType;
    @Expose @Getter public FishingContractType fishingContractType;
    @Expose @Getter public MiningContractType miningContractType;
    @Expose @Getter public WoodcuttingContractType woodcuttingContractType;
    @Expose @Getter public SmithingContractType smithingContractType;
    ...
    @Expose public boolean nmz = false;

    @Expose public int nmzCofferCoins;

    @Expose public int deathsCoffer;
    ...
    @Expose public int theatreOfBloodStage = 0;
    @Expose public String theatreroom = "";
    @Expose public boolean tobreward = false;
    @Expose public boolean scrying;
    ...
    @Expose public int prifddinasLaps;
    ...
    @Expose public int choppedCelastrus;
     ...
     * Prayer
     */
    @Expose public int fiendishAshesSpread;
    @Expose public int vileAshesSpread;
    @Expose public int maliciousAshesSpread;
    @Expose public int infernalAshesSpread;
    @Expose public int abyssalAshesSpread;
    ...
    @Expose public int seasonpassv = 0;
    @Expose public int currentLevel;
    @Expose public int currentxp;
    @Expose public List<Boolean> takenRewards = new ArrayList<>();
    @Expose public List<Level> levels = new ArrayList<>();
    ...
    @Expose public int grownRedWood;
    @Expose public int grownCelastrus;
    ...
    @Expose public int grownAttas;
    @Expose public int grownIasor;
    @Expose public int grownKronos;
    @Expose public int harvestedHespori;
    ...
    @Expose public boolean disarmedPlunderRoomTrap = false;
    @Expose public boolean inPyramidPlunder = false;
    @Expose public int nextPlunderRoomId;
    @Expose public int totalPyramidPlunderGames = 0;
    @Expose public boolean LeftPyramid = false;
    @Expose public long PyramidtimeRemaining;
    @Expose public boolean loot26580;
    @Expose public boolean loot26600;
    @Expose public boolean loot26601;
    @Expose public boolean loot26602;
    @Expose public boolean loot26603;
    @Expose public boolean loot26604;
    @Expose public boolean loot26605;
    @Expose public boolean loot26606;
    @Expose public boolean loot26607;
    @Expose public boolean loot26608;
    @Expose public boolean loot26609;
    @Expose public boolean loot26610;
    @Expose public boolean loot26611;
    @Expose public boolean loot26612;
    @Expose public boolean loot26613;
    @Expose public boolean loot26616;
    @Expose public boolean loot26626;
    ...
    @Expose public boolean goldenArmadylGodsword = false;
    @Expose public boolean goldenBandosGodsword = false;
    @Expose public boolean goldenSaradominGodsword = false;
    @Expose public boolean goldenZamorakGodsword = false;
    ...
    @Expose public boolean BarrowsMessage = false;
    ...
    public TickDelay rangersHeartCooldown = new TickDelay();
    public TickDelay berserkerHeartCooldown = new TickDelay();
    ...
    @Expose public int SilverCraftingAmount = 1;

    /**
     * Teleport interface
     */
    public int teleportSelectedCategory = -1;
    @Expose public List<Integer> favoriteTeleports = new LinkedList<>();
     ...
     * Gem bag
     */
    @Expose public int gemBagTopaz;
    @Expose public int gemBagOpal;
    @Expose public int gemBagJade;
    ...
    @Expose public int gemBagOnyx;
    @Expose public int gemBagZenyte;
     ...
     * Six Jad Challenge
     */
    @Expose public boolean Challenge2 = false;
    @Expose public boolean Challenge3 = false;
    @Expose public boolean Challenge4 = false;
    @Expose public boolean Challenge5 = false;
    @Expose public boolean Challenge6 = false;
    @Expose public JadChallenge sixjad;
    @Expose public long sixjadBestTime;
    /**
     * Inferno
     */
     ...
     * Duo Slayer
     */
    @Expose @Getter @Setter public boolean duoSlayerPartner = false;
    @Expose @Getter @Setter public String duoSlayerPartnerName = null;
    @Expose @Getter @Setter public int duoSlayerPartnerUid = -1;
    @Expose public String duoSlayerTaskName = null;
    @Expose public int duoSlayerTaskRemaining = 0;
    @Expose public int duoSlayerTasksCompleted = 0;
    @Expose public int duoSlayerSpree = 0;
    @Expose public int duoSlayerLocation = 0;
    @Expose public boolean duoSlayerCombatCheck = true;
    @Expose @Getter @Setter public int duoSlayerTaskId;
    @Expose @Getter @Setter public boolean duoSlayerHost = false;
    ...
    @Expose public int slayerExtendedCounter;
    ...
    @Expose public int taskLocation = 0;
    ...
    @Expose public String offense;

    @Expose public String jailerName;

    @Expose public long jailTime;

    @Expose public boolean jailed = false;
    ...
    @Expose public KillCounter nexKills = new KillCounter();
    ...
    @Expose public KillCounter blackDragon = new KillCounter();
    ...
    @Expose public int crystalChestsOpened;
    @Expose public int elvenCrystalChestsOpened;
    ...
    @Expose public boolean isInstanced = false;
    ...
    @Expose public boolean Shift_Drop = false;
    @Expose public boolean ESC_Close = false;
     ...
     * Blood fury effect
     */
    @Expose public boolean amuletOfBloodFuryEffect = true;
     ...
     * Wintertodt Points
     */
    @Expose public int wintertodtstorePoints;
    /**
    ...
    @Expose public int dailyTaskDate = 0;
    @Expose public int totalDailyDone = 0;
    @Expose public int totalDailyMediumDone = 0;
    @Expose public int totalDailyHardDone = 0;
    @Expose public int dailyTaskCompletePoints = 0;
    @Expose public boolean claimedDailyCache = false;
    ...
    @Expose public boolean PVPAmorNotification = true;
     ...
     * Bone Crusher
     */
    @Expose public boolean boneCrusher = true;
    @Expose public int boneCrusherChargers = 0;

    /**
     * Auto Casting Storing
     */
    @Expose public TargetSpell targetSpellStore = null;
    @Expose public int AutoCastStore = 0;
    @Expose public boolean AutoCastStorer = true;

    /**
     * Sigils
     */
    @Expose public boolean SOTRR;
    @Expose public boolean SOTMM;
    @Expose public boolean SOFR;
    @Expose public boolean SOFC;
    /**
    ...
    * Zalcano Throwing
    */
    @Expose public boolean TephraThrow = false;
    public TickDelay tephraCooldown = new TickDelay();
    @Expose public boolean TephraBoost = false;
    ...
    @Expose public int temporossPoints;
    @Expose public int temporossWins;
    public int temporossActivityScore;
    @Expose public boolean temporossTether;
    @Expose public boolean joinedTempoross;
    @Expose public int temporossrewards;
    @Expose public long temporosstimer;
...
//    @Expose public Cannon cannon;
    ...
    @Expose public boolean cannonLost = false;
    ...
    @Expose public int collectionLogTotalItemsCollected;
    @Expose public int SoulWarsSpoilsofWarOpened;
    @Expose public int barbAssaultHighLevelGambles;
    ...
    @Expose @Getter @Setter public int availableNameChanges;
    @Expose @Getter @Setter public int totalNameChanges;

    @Expose public int braceletSaves = 30;
