...
public class KingArthur {
    ...
    private static void kingDialogue(Player player, NPC npc) {
        if (PlayerCounter.KING_ARTHUR.get(player) == 0) {
            player.dialogue(new NPCDialogue(npc, "Greetings hero, welcome to RuneRogue."),
                    new NPCDialogue(npc, "Your arrival is very timely. There are many tasks that need completed and even more evils to be over-come in RuneRogue." +
        ...
        if (PlayerCounter.KING_ARTHUR.get(player) == 2) {
            player.dialogue(new PlayerDialogue("My King, the task is finished. I have slain 12 goblins."),
                    new NPCDialogue(npc, "Indeed you have! You have helped cleanse Edgeville of the goblin filth, and proven yourself worthy of this reward," +
                            " and my next task for you."),
                    new MessageDialogue("King Arthur awards you +100 Edgeville Reputation"),
                    new ActionDialogue(() -> {
        ...
        if (PlayerCounter.KING_ARTHUR.get(player) == 4 && player.varrockRep >= 500) {
            player.dialogue(new PlayerDialogue("I have earned 500 reputation with Varrock, your highness."),
                    new NPCDialogue(npc, "Well done, hero. King Roald has spoken highly of you. I award you with 200 Edgeville reputation."),
                    new MessageDialogue("King Arthur awards you +200 Edgeville Reputation"),
                    new ActionDialogue(() -> {
                        stageSix(player, npc);
                    })
            );
    ...
    public static void stageFour(Player player, NPC npc) {
        ...
        player.sendMessage("+100 Edgeville Reputation");
        PlayerCounter.KING_ARTHUR.increment(player, 1);//stage 3
        player.dialogue(new NPCDialogue(npc, "As a token of gratitude on behalf of Edgeville, I award you 100 Edgeville Reputation." +
                        " What is reputation, you wonder? Whenever you complete tasks assigned to you in any major area of Obsidian,"),
    ...
    public static void stageSix(Player player, NPC npc) {
        ...
        player.sendMessage("+200 Edgeville Reputation");
        ...
        player.dialogue(
                ...
                new NPCDialogue(npc, "continue assisting us with your heroics to push back the perils of evil and keep RuneRogue safe." +
