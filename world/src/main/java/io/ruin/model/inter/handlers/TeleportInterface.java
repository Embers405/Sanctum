...
public class TeleportInterface {
    ...
    public enum Teleport {
        ...
        CRYSTAL_SLAYER_DUNGEON(7, Catagory.DUNGEONS, "crystal slayer dungeon", Position.of(3225, 6046, 0), Difficulty.HARD, false),
        FREMMY_DUNG(8, Catagory.DUNGEONS, "Freminnik Slayer Dungeon", Position.of(2805, 10001, 0), Difficulty.HARD, false),
        KARUULM(9, Catagory.DUNGEONS, "Karuulm Dungeon", Position.of(1311, 10188, 0), Difficulty.HARD, false),
        MOSLEHARMLESS(10, Catagory.DUNGEONS, "Mos Le Harmless", Position.of(3746, 9373, 0), Difficulty.MEDIUM, false),
        SMOKE_DUNGEON(11, Catagory.DUNGEONS, "Smoke Dungeon", Position.of(3203, 9379, 0), Difficulty.HARD, false),
        SMOKE_DEVIL_DUNGEON(12, Catagory.DUNGEONS, "Smoke Devil Dungeon", Position.of(2412, 3060, 0), Difficulty.HARD, false),
        TAVERLY(13, Catagory.DUNGEONS, "Taverly Dungeon", Position.of(2884, 9799, 0), Difficulty.HARD, false),
        WATERBIRTH(14, Catagory.DUNGEONS, "Waterbirth Dungeon", Position.of(2443, 10146, 0), Difficulty.HARD, false),
        WATERFALL(15, Catagory.DUNGEONS, "Waterfall Dungeon", Position.of(2573, 9866, 0), Difficulty.HARD, false),
        ...
        GIANTROC(17, Catagory.BOSSES, "Giant Roc", Position.of(2914, 3603, 0), Difficulty.HARD, false),
        SARACHNIS(18, Catagory.BOSSES, "Sarachnis", Position.of(1846, 9915, 0), Difficulty.MEDIUM, false),
