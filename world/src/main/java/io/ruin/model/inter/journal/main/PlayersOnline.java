...
public class PlayersOnline extends JournalEntry {
    ...
    public void send(Player player) {
        send(player, "Players Online", (int) (int) Math.round((World.players.count() * 1.6)), Color.GREEN);
    }
    ...
    public void select(Player player) {
        ...
        player.sendMessage("There are currently " + (int) Math.round((World.players.count() * 1.6)) + " players online.");
    }
