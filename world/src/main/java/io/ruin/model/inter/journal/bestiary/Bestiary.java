...
public class Bestiary {
    ...
    private static void sendBoxes(Player player) {
        List<DropTableEntry> results = player.dropTableSearchResults = new ArrayList<>(Arrays.asList(
                ...
                new DropTableEntry("champion box", MysteryBox.MYSTERY_BOX_TABLE),
                new DropTableEntry("Luxury box",  LuxuryBox.MYSTERY_BOX_TABLE),
                new DropTableEntry("mega box", LegendaryBox.MYSTERY_BOX_TABLE),
                new DropTableEntry("Ancient cascet", ancientcascet.ANCIENT_TABLE),
                new DropTableEntry("nex", NexCombat.regularTable),
                new DropTableEntry("nightmare", NightmareCombat.regularTable),
              //  new DropTableEntry("chambers of xeric", XericRewards.regularTable),
