...
public class RiskProtection extends JournalToggle {
    ...
    public JournalTab.TextField getText() {
        return player -> "Risk Protection: " + get(player);
    }
    ...
    private String get(Player player) {
        ...
        Color color = tier == 0 ? Color.RED : Color.GREEN;

        return color.wrap(protectionState(player));
    }
