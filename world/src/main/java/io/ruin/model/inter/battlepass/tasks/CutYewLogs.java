...
public class CutYewLogs implements AchievementListener {

    @Expose private int counterStartValue = 0;

    private static PlayerCounter counters = Tree.YEW.counter;
    ...
    public int get(Player player) {
        counterStartValue = player.getBattlePass().tasks.cut10Yew.counterStartValue;
    ...
    public String[] lines(Player player, boolean finished) {
        return new String[]{
                ...
                "",
                Achievement.slashIf("<col=000080>Assignment</col>: Chop " + amount + " Yew logs from a Yew tree.", finished),
