...
public class Config {
    ...
    public static final String GROUP_SAVE_DIRECTORY = System.getProperty("user.home") + "/Desktop/Obsidian/gim/";
...
*/
    ...
    public static final Config LARRANS_CHEST = varpbit(6583, true);
    //so if this works we can easily add icons to it, then config save this value in there player file.
    ///ok I broke your player file
     ...
     * Quest points
     */
    public static final Config QUEST_POINTS = varp(101, true);
...
//    public static final Config GWD_ZAROS_KC = varpbit(13080, true);
    ...
    */
     ...
     * Gamemode (ironman)
     */
    public static final Config IRONMAN_MODE = varpbit(1777, true);// <-- ironman mode.
//where is the client ? the one you had open. ya good
    /**
