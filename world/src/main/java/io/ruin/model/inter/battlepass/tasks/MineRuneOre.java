...
public class MineRuneOre implements AchievementListener {

    @Expose
    public int counterStartValue = 0;

    private static PlayerCounter counters = PlayerCounter.MINED_RUNITE;
    ...
    private String oreName = "Runite Ore";

    public MineRuneOre(int i) {
        amount = i;
        xpReward = amount * 25;
    ...
    public int get(Player player) {
        counterStartValue = player.getBattlePass().tasks.Mine10Rune.counterStartValue;
