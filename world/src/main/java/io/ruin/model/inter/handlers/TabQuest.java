...
public class TabQuest {
    ...
    private enum NoticeboardComponent {
        ...
        COMPONENT_8(8, player -> "Players Online: " + Color.GREEN.wrap(String.valueOf((int) Math.round((World.players.count() ))))),
        ...
        }, (SimpleAction) player -> player.openUrl("https://obsidian-ps.com/index.php")), //need to hookup tfa to the website somehow
        ...
        COMPONENT_53(53, player -> "FunPkPoints Points: " + Color.GREEN.wrap(Integer.toString(player.FunPkPoints))),
