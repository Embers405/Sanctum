...
public class TradePostOffer {
    ...
    public TradePostOffer(String userId, String username, Item item, int pricePerItem, long timestamp) {
        this.userId = userId;
    ...
    public long getAdEnd() { return adEnd; }

    public void setAdEnd(long adEnd) { this.adEnd = adEnd; }
