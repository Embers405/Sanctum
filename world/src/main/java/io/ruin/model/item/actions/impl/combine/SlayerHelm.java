...
public class SlayerHelm {
    ...
    private static final List<Integer> MELEE_BOOST_HELMS = Arrays.asList(
            8901, 8903, 8905, 8907, 8909, 8911, 8913, 8915, 8917, 8919, 8921,11784,25276, // black masks
    ...
    static {
        ...
        ItemItemAction.register(24466, SLAYER_HELM, (player, primary, secondary) -> addTwistedHornsToHelm(player, primary, secondary, 24466));
        ItemItemAction.register(24466, SLAYER_HELM_IMBUE, (player, primary, secondary) -> addTwistedHornsToHelm(player, primary, secondary, 24466));
