...
import io.ruin.model.combat.special.ranged.bolts.dragon.OpalDragonBoltEffect;
...
public enum RangedAmmo {
    ...
    OBSIDIAN_ARROW(new RangedData(1116, 1111, Projectile.arrow(1120))),
    ...
    DRAGON_OPAL_BOLTS(new RangedData(Projectile.DRAGON_BOLT), new OpalDragonBoltEffect()),
