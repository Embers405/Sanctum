    ...
    public void clip(boolean remove) {
        ...
        if(type == 22) {
            ...
            if(def.interactType != 0) {
                if(remove) {
                    ClipUtils.removeClipping(x, y, z, xLength, yLength, def.blocksProjectile, false);
                    if(def.blocksProjectile)
                        ClipUtils.removeClipping(x, y, z, xLength, yLength, true, true);
                } else {
                    ClipUtils.addClipping(x, y, z, xLength, yLength, def.blocksProjectile, false);
                    if(def.blocksProjectile)
            ...
            if(def.interactType != 0) {
                if(remove) {
                    ClipUtils.removeVariableClipping(x, y, z, type, direction, def.blocksProjectile, false);
                    if(def.blocksProjectile)
                        ClipUtils.removeVariableClipping(x, y, z, type, direction, true, true);
                } else {
                    ClipUtils.addVariableClipping(x, y, z, type, direction, def.blocksProjectile, false);
                    if(def.blocksProjectile)
