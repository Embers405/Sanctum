...
//        if (npc.getId() == 9049 && hit.attackWeapon.id != 23907) {
//            hit.hide();
//            hit.block();
...
//            return;
//        }
//        if (hit.attackWeapon.id == 23907) {
//            hit.damage = (int) (hit.damage * 2.50);
//        }
//        if (npc.getId() == 9049) {
//            attackMode();
//        }
//        int remaining = npc.getHp() - hit.damage;
//        if (remaining <= 0 && npc.getId() == 9049) {
//            npc.getCombat().restore();
//            npc.transform(9050);
//            npc.setMaxHp(health);
//            npc.setHp(health);
//            zalcanoPhase.delay(16);
//            miningPhase = true;
//        }
//
//    }
...
//
//    static {
//        NPCAction.register(9050,1,(player, npc) -> {
//            player.startEvent(e -> {
//               player.animate(624);
//               health -= Random.get(0, 15);
//               player.getStats().addXp(StatType.Mining, 1.0, true);
//               if (zalcanoPhase.finished()) {
//                   npc.getCombat().restore();
//                   npc.transform(9049);
//                   npc.setMaxHp(300);
//                   npc.setHp(300);
