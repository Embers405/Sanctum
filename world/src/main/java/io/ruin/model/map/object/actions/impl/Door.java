...
//        }
        ...
        boolean verticalFlip = def.rotated;
        ...
        if (pairObj != null) {
            if (!def.doorClosed) {
                if (!skipJammedCheck && isJammed(player, def.rotated ? pairObj : obj)) {
...
//                HouseStyle.FANCY_STONE.doorId1, HouseStyle.FANCY_STONE.doorId2,
        ...
        ObjectAction.register(16774, 2451, 4644, 0, "open", (player, obj) -> player.sendFilteredMessage("The door seems to be stuck."));

        ObjectAction.register(2882, "open", (player, obj) -> {
            player.startEvent(e -> {
                if (player.getPosition().getX() > obj.getPosition().getX()) {
                    player.getMovement().teleport(obj.getPosition().getX() - 1, obj.getPosition().getY());
                } else {
                    player.getMovement().teleport(obj.getPosition().getX() + 1, obj.getPosition().getY());
                }
            });
        });
        ObjectAction.register(2883, "open", (player, obj) -> {
            player.startEvent(e -> {
                if (player.getPosition().getX() > obj.getPosition().getX()) {
                    player.getMovement().teleport(obj.getPosition().getX() - 1, obj.getPosition().getY());
                } else {
        ...
        ObjectAction.register(2882, 4, (player, obj) -> {
            player.startEvent(e -> {
                if (player.getPosition().getX() > obj.getPosition().getX()) {
                    player.getMovement().teleport(obj.getPosition().getX() - 1, obj.getPosition().getY());
                } else {
        ...
        ObjectAction.register(2883, 4, (player, obj) -> {
            player.startEvent(e -> {
                if (player.getPosition().getX() > obj.getPosition().getX()) {
                    player.getMovement().teleport(obj.getPosition().getX() - 1, obj.getPosition().getY());
                } else {
        ...
        ObjectAction.register(1732, 1, (player, obj) -> {
            player.startEvent(e -> {
                if (player.getPosition().getX() == 2584) {
                    player.getMovement().teleport(obj.getPosition().getX() + 1, obj.getPosition().getY());
                } else if (player.getPosition().getX() == 2585) {
                    player.getMovement().teleport(obj.getPosition().getX() - 1, obj.getPosition().getY());
                } else if (player.getPosition().getX() == 2596) {
                    player.getMovement().teleport(obj.getPosition().getX() + 1, obj.getPosition().getY());
                } else if (player.getPosition().getX() == 2597) {
                    player.getMovement().teleport(obj.getPosition().getX() - 1, obj.getPosition().getY());
                }
            });
        });
        ObjectAction.register(1733, 1, (player, obj) -> {
            player.startEvent(e -> {
                if (player.getPosition().getX() == 2584) {
                    player.getMovement().teleport(obj.getPosition().getX() + 1, obj.getPosition().getY());
                } else if (player.getPosition().getX() == 2585) {
        ...
        ObjectAction.register(1967, "open", (player, obj) -> {
        ...
        ObjectAction.register(1968, "open", (player, obj) -> {
            if (player.getPosition().getY() < obj.getPosition().getY()) {
                player.step(0,2,StepType.FORCE_WALK);
            } else {
                player.step(0,-2,StepType.FORCE_WALK);
        ...
        ObjectAction.register(16105, "pass", (player, obj) -> {
            if (player.getPosition().getY() < obj.getPosition().getY()) {
                player.step(0,2,StepType.FORCE_WALK);
        ...
        ObjectAction.register(16105, "pay-toll(2-ecto)", (player, obj) -> {
            if (player.getPosition().getY() < obj.getPosition().getY()) {
                player.step(0,2,StepType.FORCE_WALK);
            } else if (player.getPosition().getY() > obj.getPosition().getY()){
                player.step(0,-2,StepType.FORCE_WALK);
    ...
    private static int findOppositeId(ObjectDef originalDef) {
        ...
        for (ObjectDef def : ObjectDef.LOADED.values()) {
            ...
            if (!Arrays.equals(def.modifiedModelColors, originalDef.modifiedModelColors))
                continue;
            if (def.rotated != originalDef.rotated)
                continue;
