...
public class PollBooth {
    ...
    public static void openPollInterface(@Nonnull Player player) {
        ...
        player.getPacketSender().sendClientScript(603, "sIIIIs", "RuneRogue Content Poll #" + poll.getPollNumber() + ": " + poll.getPollTitle(),
        ...
        player.getPacketSender().sendClientScript(610, "ssI", "Click here to visit the forums.", "https://discord.gg/Jf3zxrrKjZ", 22609931);
    ...
    public static void openVoteInterface(@Nonnull Player player) {
        ...
        player.getPacketSender().sendClientScript(603, "sIIIIs",
                "Obsidian Poll #" + poll.getPollNumber() + ": " + poll.getPollTitle(), 26214403, 26214413, 26214410, 26214409, "Building...");
        player.getPacketSender().sendClientScript(609, "siidfiiI",
    ...
    public static Object[] generateParameters(PollQuestion question, int index) {
        ...
        for (int i = 0; i < question.getVotes().size(); i++) {
            parms.add((Integer) question.getVotes().get(i));
        }
        ...
        return new Object[]{
                ...
                (Integer) question.getAnswers().size(), 0, (Integer) parms.get(0), (Integer) parms.get(1), (Integer) parms.get(2),
...
//        };
    ...
    public static void refreshInterface(@Nonnull Player player, @Nonnull PlayerBallot ballot) {
        ...
        player.getPacketSender().sendClientScript(603, "sIIIIs",
                "Obsidian Poll #" + poll.getPollNumber() + ": " + poll.getPollTitle(),
