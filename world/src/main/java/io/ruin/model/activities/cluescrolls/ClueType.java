...
public enum ClueType {
    ...
    EASY(
             ...
             * Teleport Scrolls
             **/
            new LootItem(12402, 1, 1),
            new LootItem(12403, 1, 1),
            new LootItem(12404, 1, 1),
            new LootItem(12405, 1, 1),
            new LootItem(12406, 1, 1),
            new LootItem(12407, 1, 1),
            new LootItem(12408, 1, 1),
            new LootItem(12409, 1, 1),
            new LootItem(12410, 1, 1),
            new LootItem(12411, 1, 1),
            /**
             * Rare (4 / 25)
             */
            ...
            new LootItem(20220, 1, 1),          //Holy Blessing
            new LootItem(20223, 1, 1),          //UnHoly Blessing
            new LootItem(20226, 1, 1),          //Peaceful Blessing
            new LootItem(20229, 1, 1),          //Honourable Blessing
            new LootItem(20232, 1, 1),          //War Blessing
            new LootItem(20235, 1, 1)          //Ancient Blessing
    ),
    MEDIUM(
            2801, 20545, 3, 5,
            /**
            ...
            /**
            * (H) Addy armour 15 pieces
            */
            new LootItem(10296, 1, 10),          //Adamant Helm (h1)
            new LootItem(10298, 1, 10),          //Adamant Helm (h2)
            new LootItem(10300, 1, 10),          //Adamant Helm (h3)
            new LootItem(10302, 1, 10),          //Adamant Helm (h4)
            new LootItem(10304, 1, 10),          //Adamant Helm (h5)
            new LootItem(23392, 1, 10),          //Adamant Platebody (h1)
            new LootItem(23395, 1, 10),          //Adamant Platebody (h2)
            new LootItem(23398, 1, 10),          //Adamant Platebody (h3)
            new LootItem(23401, 1, 10),          //Adamant Platebody (h4)
            new LootItem(23404, 1, 10),          //Adamant Platebody (h5)
            new LootItem(7334, 1, 10),          //Adamant Shield (h1)
            new LootItem(7340, 1, 10),          //Adamant Shield (h2)
            new LootItem(7346, 1, 10),          //Adamant Shield (h3)
            new LootItem(7352, 1, 10),          //Adamant Shield (h4)
            new LootItem(7358, 1, 10),          //Adamant Shield (h5)

            /**
             * Teleport Scrolls
             **/
            new LootItem(12402, 1, 5),
            new LootItem(12403, 1, 5),
            new LootItem(12404, 1, 5),
            new LootItem(12405, 1, 5),
            new LootItem(12406, 1, 5),
            new LootItem(12407, 1, 5),
            new LootItem(12408, 1, 5),
            new LootItem(12409, 1, 5),
            new LootItem(12410, 1, 5),
            new LootItem(12411, 1, 5),
    ...
    ELITE(
            ...
            new LootItem(20220, 1, 10),          //Holy Blessing
            new LootItem(20223, 1, 10),          //UnHoly Blessing
            new LootItem(20226, 1, 10),          //Peaceful Blessing
            new LootItem(20229, 1, 10),          //Honourable Blessing
            new LootItem(20232, 1, 10),          //War Blessing
            new LootItem(20235, 1, 10),          //Ancient Blessing
            /**
             * Mega rare (1 / 206.25)
             */
    ...
    private boolean hasCluePerk(Player player) {
    ...
    public void loot(Player player) {
        ...
        for(int i = 0; i < Random.get(1, 6); i++) {
    ...
    static {
        ...
        ItemAction.registerInventory(24361, "open", (player, item) -> {
            if (player.getInventory().getFreeSlots() < 1) {
                player.sendMessage("You don't have enough room in your inventory");
                return;
            }
            if (player.getInventory().contains(23182) || player.getBank().contains(23182)) {
                player.sendMessage("You must complete your other clues first!");
                return;
            }
            item.remove(1);
            player.getInventory().add(23182);
        });
        ItemAction.registerInventory(24362, "open", (player, item) -> {
            if (player.getInventory().getFreeSlots() < 1) {
                player.sendMessage("You don't have enough room in your inventory");
                return;
            }
            if (player.getInventory().contains(2677) || player.getBank().contains(2677)) {
                player.sendMessage("You must complete your other clues first!");
                return;
            }
            item.remove(1);
            player.getInventory().add(2677);
        });
        ItemAction.registerInventory(24363, "open", (player, item) -> {
            if (player.getInventory().getFreeSlots() < 1) {
                player.sendMessage("You don't have enough room in your inventory");
                return;
            }
            if (player.getInventory().contains(2801) || player.getBank().contains(2801)) {
                player.sendMessage("You must complete your other clues first!");
                return;
            }
            item.remove(1);
            player.getInventory().add(2801);
        });
        ItemAction.registerInventory(24364, "open", (player, item) -> {
            if (player.getInventory().getFreeSlots() < 1) {
                player.sendMessage("You don't have enough room in your inventory");
                return;
            }
            if (player.getInventory().contains(2722) || player.getBank().contains(2722)) {
                player.sendMessage("You must complete your other clues first!");
                return;
            }
            item.remove(1);
            player.getInventory().add(2722);
        });
        ItemAction.registerInventory(24365, "open", (player, item) -> {
            if (player.getInventory().getFreeSlots() < 1) {
                player.sendMessage("You don't have enough room in your inventory");
                return;
            }
            if (player.getInventory().contains(12073) || player.getBank().contains(12073)) {
                player.sendMessage("You must complete your other clues first!");
                return;
            }
            item.remove(1);
            player.getInventory().add(12073);
        });
        ItemAction.registerInventory(24366, "open", (player, item) -> {
            if (player.getInventory().getFreeSlots() < 1) {
                player.sendMessage("You don't have enough room in your inventory");
                return;
            }
            if (player.getInventory().contains(19835) || player.getBank().contains(19835)) {
                player.sendMessage("You must complete your other clues first!");
                return;
            }
            item.remove(1);
            player.getInventory().add(19835);
        });
    }
