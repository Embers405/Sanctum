...
public class Leaderboard {
     ...
     * Edgeville Pkers
     */
    public static HashMap<String, EdgePker> edgePkers = new HashMap<>();

    /**
     * Deep Wilderness Pkers
     */
    public static HashMap<String, DeepWildernessPker> deepWildernesPkers = new HashMap<>();
    ...
    static {
        ...
        LoginListener.register(player -> {
            if (!unclaimedRewards.isEmpty()) {
                unclaimedRewards.stream().filter(reward -> player.getName().equalsIgnoreCase(reward.userId)).findAny().ifPresent(reward -> {
        ...
        World.startEvent(event -> {
            ...
            if (topThreeEdge != null) {
                ...
                if (firstPlacePlayer != null) {
                    ...
                    unclaimedRewards.add(new Reward(firstPlace.getName(), firstPlaceReward));
                }
                ...
                if (secondPlacePlayer != null) {
                    ...
                    unclaimedRewards.add(new Reward(secondPlace.getName(), secondPlaceReward));
                }
                ...
                if (thirdPlacePlayer != null) {
                    ...
                    unclaimedRewards.add(new Reward(thirdPlace.getName(), thirdPlaceReward));
                }
    ...
    static class Reward {
        ...
        Reward(String userId, Item reward) {
            this.userId = userId;
            this.reward = reward;
        }
    }
