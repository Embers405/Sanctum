...
public class GambleManager {
    ...
    private static final Position playerOneFinalPosition = new Position(3084, 3468, 0);
    private static final Position playerTwoFinalPosition = new Position(3087, 3468, 0);
    ...
    private static void serializeRooms() {
        freeFlowerPokerRooms = 9;
        flowerPokerRooms = new ArrayList<>();

        flowerPokerRooms.add(new FlowerPokerRoom(5, new Position(3092, 3482, 0), new Position(3091, 3482, 0), false, Direction.SOUTH));
        flowerPokerRooms.add(new FlowerPokerRoom(5, new Position(3088, 3482, 0), new Position(3087, 3482, 0), false, Direction.SOUTH));
    ...
    private static boolean inGambleZone(Position position) {
        if (position.inBounds(new Bounds(3074, 3467, 3097, 3484, 0))) {
            return true;
        }
        return false;
    }
    ...
    static {
        ...
        MapListener.registerBounds(new Bounds(3074, 3467, 3097, 3484, 0))
