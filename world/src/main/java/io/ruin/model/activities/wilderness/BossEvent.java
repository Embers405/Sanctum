...
public class BossEvent extends JournalEntry {
    ...
    private static double bloodMoneyPerDamage(Player player) {
        ...
        /*if (player.isGroup(PlayerGroup.DRAGON)) {
            return 9.0;
        } else if (player.isGroup(PlayerGroup.RUNE)) {
            return 8.0;
        } else if (player.isGroup(PlayerGroup.ADAMANT)) {
            return 7.0;
        } else if (player.isGroup(PlayerGroup.MITHRIL)) {
            return 6.0;
        } else if (player.isGroup(PlayerGroup.GOLD)) {
            return 5.0;
        } else if (player.isGroup(PlayerGroup.BRONZE)) {
            return 4.0;
        } else {
            return BLOOD_MONEY_PER_DAMAGE;
        }*/
...
//        } else if (player.isGroup(PlayerGroup.GOLD)) {
//            return 500.0;
//        } else if (player.isGroup(PlayerGroup.IRON)) {
//            return 400.0;
//        } else if (player.isGroup(PlayerGroup.BRONZE)) {
//            return 300.0;
//        } else {
