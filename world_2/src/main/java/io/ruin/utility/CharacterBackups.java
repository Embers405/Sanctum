...
public class CharacterBackups {
    ...
    private static final String BACKUP_PATH = System.getProperty("user.home") + "/Desktop/Obsidian/backups/";
    ...
    public void start() {
        if (World.stage == WorldStage.LIVE) {
            ...
            CHARACTER_SAVES_PATH = System.getProperty("user.home") + "/Desktop/Obsidian/_saved/players/" + World.stage.name().toLowerCase() + "/" + World.type.name().toLowerCase() + "/";
        }
    }
