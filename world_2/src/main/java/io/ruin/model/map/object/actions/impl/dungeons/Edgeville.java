...
public class Edgeville {
    ...
    static {
        ...
        ObjectAction.register(17385, 2463, 9897, 0, "climb-up", (player, obj) -> Ladder.climb(player, 2464, 3497, 0, true, true, false));
        ObjectAction.register(2446, 2463, 3497, 0, "open", (player, obj) -> Ladder.climb(player, 2464, 9897, 0, false, true, false));
        ObjectAction.register(2451, 2466,9904,0, "push", (player, obj) -> {
            player.startEvent(e -> {
                player.lock();
