...
public class ForthosDungeon {
    ...
    static {
        ObjectAction.register(34862, "climb-down", (player, obj) -> {
            climb(player, 1830, 9975, 0, false, true, false);
        });
        ObjectAction.register(34863, "climb-up", (player, obj) -> {
            climb(player, 1702, 3575, 0, true, true, false);
        });
