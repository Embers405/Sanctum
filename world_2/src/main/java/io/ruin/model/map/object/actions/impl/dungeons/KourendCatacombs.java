...
public class KourendCatacombs {
    ...
    static { // Object actions
        ...
        Tile.get(1696,10085, 0, true).flagUnmovable(); // block floor
        Tile.get(1697,10085, 0, true).flagUnmovable(); // block floor
        Tile.get(1698,10083, 0, true).flagUnmovable(); // block floor
        ...
        ObjectAction.register(28897, "climb-up", (player, obj) -> { // SE
            Ladder.climb(player, 1803, 9967, 0, true, true, false);
    ...
    public static void drop(Player pKiller, NPC npc, Position dropPosition) {
        ...
        if (Random.rollDie(10, 1) && npc.getId() != 10) {
