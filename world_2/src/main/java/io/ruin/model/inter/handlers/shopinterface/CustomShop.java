...
public enum CustomShop {
    ...
    DONATOR_STORE(
            ...
            new ShopItem[]{
                    new ShopItem(962,300), // Christmas Cracker
                    new ShopItem(6806,5), // green skin scroll
                    new ShopItem(6807,5), // blue skin scroll
                    new ShopItem(6808,5), // purple skin scroll
                    new ShopItem(11663,10), // Void Mage
                    new ShopItem(11664,10), // Void Range
                    new ShopItem(11665,10), // Void Melee
                    new ShopItem(13072,15), // Void Elite Top
                    new ShopItem(13073,15), // Void Elite Bottoms
                    new ShopItem(8842,5), // Void Gloves
                    new ShopItem(12791,20), // Rune Pouch
                    new ShopItem(6570,15), // Fire Cape
                    new ShopItem(12954,15), // Dragon Defender
                    new ShopItem(11941,10), // Looting bag
                    new ShopItem(10834,150), // Dice bag
                    new ShopItem(6199,10), // Champion Box
                    new ShopItem(290,25), // Luxury Box
                    new ShopItem(6828,50), // Mega Box
    ...
    VOTE_STORE(
            ...
            new ShopItem[]{
                    new ShopItem(989,4),
                    new ShopItem(6806,25), // green skin scroll
                    new ShopItem(6807,25), // blue skin scroll
                    new ShopItem(6808,25), // purple skin scroll
