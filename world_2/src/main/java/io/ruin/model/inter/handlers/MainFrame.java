...
public class MainFrame {
    ...
    static {
        ...
        NPCAction.register(7046, "teleport", (player, npc) -> TeleportInterface.open(player));
        NPCAction.register(7046, "prev-teleport", (player, npc) -> player.getMovement().teleport(player.lastTeleport));
