...
public class TeleportList {
    ...
    public enum Category {
        ...
        CITIES("Cities", 1131, 10, 10, Teleport.AL_KHARID, Teleport.ARDOUGNE, Teleport.BRIMHAVEN,  Teleport.BURTHORPE, Teleport.CAMELOT, Teleport.CANIFIS, Teleport.CATHERBY, Teleport.DRAYNOR_VILLAGE,  Teleport.EDGEVILLE, Teleport.ENTRANA, Teleport.FALADOR, Teleport.GREAT_KOUREND, Teleport.KEBOS_LOWLANDS, Teleport.KARAMJA_DOCKS, Teleport.LUMBRIDGE, Teleport.LLEYTA, Teleport.LUNAR_ISLE, Teleport.MOS_LE_HARMLESS, Teleport.NEITIZNOT, Teleport.POLLNIVNEACH, Teleport.PORT_SARIM, Teleport.PRIFDDINAS,  Teleport.RELLEKKA,  Teleport.SEERS_VILLAGE, Teleport.SHILO_VILLAGE, Teleport.TREE_GNOME_STRONGHOLD, Teleport.VARROCK, Teleport.VER_SINHAZA, Teleport.WATERBIRTH_ISLAND, Teleport.YANILLE ),
        DUNGEONS("Dungeons", 1131, 10, 10, Teleport.ANCIENT_CAVERN, Teleport.ASGARNIA_ICE_CAVE, Teleport.BASILISK_KNIGHT_CAVE, Teleport.BRIMHAVEN_DUNGEON, Teleport.BRINE_RAT_CAVERN, Teleport.CATACOMBS_OF_KOUREND , Teleport.CRYSTAL_SLAYER_DUNGEON, Teleport.CRASH_SITE_CAVERN, Teleport.EDGEVILLE_DUNGEON, Teleport.FIRE_CHASM, Teleport.FORTHOS_DUNGEON, Teleport.GODWARS_DUNGEON, Teleport.LITHKREN_LABORATORY, Teleport.Lighthouse_Dungeon, Teleport.LUMBRIDGE_SWAMPCAVES, Teleport.MOS_LE_HARMLESS_DUNGEON,Teleport.MOUNT_KARUULM, Teleport.MOURNER_TUNNELS, Teleport.RELLEKA_SLAYER_CAVE, Teleport.TAVERLY_DUNGEON, Teleport.SMOKE_DUNGEON, Teleport.STRONGHOLD_SLAYER_CAVE, Teleport.SLAYER_TOWER, Teleport.JUNGLE_DEMONS, Teleport.Waterfall_Dungeon),
        TRAINING("Training", 1131, 10, 10, Teleport.EASY_TRAINING, Teleport.MED_TRAINING, Teleport.HARD_TRAINING, Teleport.AMMONITE_CRABS, Teleport.APE_ATOLL, Teleport.BANDIT_CAMP, Teleport.EXPERIMENTS, Teleport.GOBLINS, Teleport.LIZARD_CANYON, Teleport.MORYTANIA_SLAYER_TOWER, Teleport.ROCK_CRABS, Teleport.SAND_CRABS, Teleport.STRONGHOLD_SECURITY, Teleport.TROLLHEIM_TROLLS, Teleport.YAKS, Teleport.Warrior),
        MINIGAMES("Minigames", 1131, 10, 10, Teleport.BARROWS, Teleport.BLAST_FURNACE, Teleport.CASTLE_WARS, Teleport.CHAMBERS_OF_XERIC, Teleport.TOB, Teleport.DUEL_ARENA, Teleport.FIGHT_CAVE, Teleport.INFERNO, Teleport.LAST_MAN_STANDING, Teleport.MOTHERLODE_MINE, Teleport.PEST_CONTROL, Teleport.PURO_PURO, Teleport.PYRAMID_PLUNDER, Teleport.WARRIORS_GUILD, Teleport.WINTERTODT),
        WILDERNESS("Wilderness", 1131, 10, 10, Teleport.CHAOS_ELEMENTAL, Teleport.EAST_DRAGONS, Teleport.FEROX_ENCLAVE, Teleport.GRAVEYARD_OF_SHADOWS, Teleport.GREATER_DEMONS, Teleport.ICE_PLATEAU, Teleport.LAVA_MAZE, Teleport.MAGE_BANK, Teleport.REVENANTS, Teleport.RESOURCE_AREA, Teleport.WEST_DRAGONS),
        SKILLING("Skilling", 1131, 10, 10,  Teleport.ABYSS,Teleport.AERIAL_FISHING, Teleport.BARB_FISHING, Teleport.COOKING_GUILD, Teleport.CRAFTING_GUILD, Teleport.DENSE_ESSENCE, Teleport.DESERT_HUNTER, Teleport.FELDIP_HILLS, Teleport.FISHING_GUILD, Teleport.GEM_MINE, Teleport.GNOME_AGILITY, Teleport.JATIZSO_MINE, Teleport.KARAMJA_DOCKS, Teleport.KARAMBWAN_FISHING, Teleport.KOUREND_ANGLERS,Teleport.MINING_GUILD, Teleport.MISCELLANIA, Teleport.PISCATORIS_FISHING_COLONY, Teleport.PURE_ESSENCE_MINING, Teleport.RANGING_GUILD, Teleport.WOODCUTTING_GUILD, Teleport.WOODLAND_HUNTER),
        BOSSES("Bosses", 1131, 10, 10, Teleport.DONATION_BOSS,Teleport.VOTE_BOSS,Teleport.ABYSSAL_SIRE, Teleport.CERBERUS, Teleport.CORPOREAL_BEAST, Teleport.DAGGANOTH_LAIR, Teleport.GALVEK, Teleport.GIANT_MOLE, Teleport.GODWARS_DUNGEON, Teleport.KALPHITE_QUEEN, Teleport.KING_BLACK_DRAGON, Teleport.KRAKEN, Teleport.NIGHTMARE_OF_ASHIHAMA, Teleport.SMOKE_DEVIL, Teleport.VORKATH, Teleport.NEX, Teleport.ZULRAH,  Teleport.GIANTROC,Teleport.SARACHNIS, Teleport.YAMA),
        MISC("Misc", 1131, 10, 10, Teleport.DEATHS_DOMAIN, Teleport.CHAMPIONS_GUILD, Teleport.GRAND_EXCHANGE, Teleport.MYTHS_GUILD);
    ...
    public enum Teleport {
        ...
        VER_SINHAZA(28, TeleportConstants.VER_SINHAZA, false, false),
        ...
        CRYSTAL_SLAYER_DUNGEON(143, TeleportConstants.CRYSTAL_SLAYER_DUNGEON, false, false),
        ...
        Warrior(146, TeleportConstants.WARRIORS, false, false),
        ...
        TOB(85,"Theatre of Blood", TeleportConstants.TOB, false, false),
        ...
        YAMA(143,"YAMA", TeleportConstants.YAMA, true,false),
        GIANTROC(144, "Giantroc", TeleportConstants.GIANTROC, false,false),
        SARACHNIS(145, "Sarachnis", TeleportConstants.SARACHNIS, false, false),
        NEX(146, TeleportConstants.NEX, false, false),
        ...
        DEATHS_DOMAIN(140, World.DEATHS_DOMAIN, false, false),
        ;
