...
public class BattlePass {
    ...
    @Expose public int version = 0;
    @Expose private static int maxLevel;
    @Expose private int startLevel = 0;
    @Expose private static int currentLevel;
    @Expose private static int currentxp;
    @Expose private boolean unlocked;

    private static String endsIn;
    private static int currentPage;
    @Expose public boolean hasPaidFor;
    ...
    public static void initLevels(Player player) {
        ...
        player.levels.add(new Level(36, 30250, 1,0));			// $10 bond
