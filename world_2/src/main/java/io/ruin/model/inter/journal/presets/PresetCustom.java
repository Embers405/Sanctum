...
public class PresetCustom extends Preset {
    ...
    public static final PresetCustom[] ENTRIES = {
            ...
            new PresetCustom(4),
            new PresetCustom(5),
            new PresetCustom(6, SecondaryGroup.BRONZE, SecondaryGroup.GOLD, SecondaryGroup.MITHRIL, SecondaryGroup.ADAMANT, SecondaryGroup.RUNE, SecondaryGroup.DRAGON),
            new PresetCustom(7, SecondaryGroup.GOLD, SecondaryGroup.MITHRIL, SecondaryGroup.ADAMANT, SecondaryGroup.RUNE, SecondaryGroup.DRAGON),
            new PresetCustom(8, SecondaryGroup.MITHRIL, SecondaryGroup.ADAMANT, SecondaryGroup.RUNE, SecondaryGroup.DRAGON),
            new PresetCustom(9, SecondaryGroup.ADAMANT, SecondaryGroup.RUNE, SecondaryGroup.DRAGON),
            new PresetCustom(10, SecondaryGroup.RUNE, SecondaryGroup.DRAGON),
            new PresetCustom(11, SecondaryGroup.DRAGON),
    };
    ...
    public static final PresetCustom[] ECO_ENTRIES = {
            ...
            new PresetCustom(8),
            new PresetCustom(9),
            new PresetCustom(1, SecondaryGroup.BRONZE, SecondaryGroup.GOLD, SecondaryGroup.MITHRIL, SecondaryGroup.ADAMANT, SecondaryGroup.RUNE, SecondaryGroup.DRAGON),
            new PresetCustom(2, SecondaryGroup.GOLD, SecondaryGroup.MITHRIL, SecondaryGroup.ADAMANT, SecondaryGroup.RUNE, SecondaryGroup.DRAGON),
            new PresetCustom(3, SecondaryGroup.MITHRIL, SecondaryGroup.ADAMANT, SecondaryGroup.RUNE, SecondaryGroup.DRAGON),
            new PresetCustom(4, SecondaryGroup.ADAMANT, SecondaryGroup.RUNE, SecondaryGroup.DRAGON),
            new PresetCustom(5, SecondaryGroup.RUNE, SecondaryGroup.DRAGON),
            new PresetCustom(6, SecondaryGroup.DRAGON),
    };
    ...
    private int id;
    private SecondaryGroup[] donatorGroups;

    public PresetCustom(int id, SecondaryGroup... donatorGroups) {
        this.id = id;
    ...
    public void selectStart(Player player) {
        ...
        if (donatorGroups != null && donatorGroups.length > 0) {
            ...
            for (SecondaryGroup tier : donatorGroups) {
                if (player.isGroups(tier)) {
                    allowed = true;
                    break;
                }
            }
