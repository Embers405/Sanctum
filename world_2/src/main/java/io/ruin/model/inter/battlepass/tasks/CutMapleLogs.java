...
public class CutMapleLogs implements AchievementListener {

    @Expose
    private int counterStartValue = 0;

    private static PlayerCounter counters = Tree.MAPLE.counter;
    ...
    public int get(Player player) {
        counterStartValue = player.getBattlePass().tasks.cut10Maple.counterStartValue;
    ...
    public String[] lines(Player player, boolean finished) {
        return new String[]{
                ...
                "",
                Achievement.slashIf("<col=000080>Assignment</col>: Chop " + amount + " Maple logs from a Maple tree.", finished),
