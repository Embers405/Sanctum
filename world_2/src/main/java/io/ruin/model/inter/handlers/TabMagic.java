...
public class TabMagic {
    ...
    static {
        ...
        LoginListener.register(player -> {
            Config.BLIGHTED_SACKS.set(player, 1);
            Config.ANCIENT_MAGIC_SPELLS.set(player, 15);
            Config.LUNAR_MAGIC_SPELLS.set(player, 190);
            Config.ARCEEUS_MAGIC_SPELLS.set(player, 150);
            Config.HARMONY_ISLAND_TELEPORT.set(player, 130);
        });
    }
