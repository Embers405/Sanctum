...
public class CutMagicLogs implements AchievementListener {

    @Expose
    public int counterStartValue = 0;

    private static PlayerCounter counters = Tree.MAGIC.counter;
    ...
    public int get(Player player) {
        counterStartValue = player.getBattlePass().tasks.cut10Magic.counterStartValue;
    ...
    public String[] lines(Player player, boolean finished) {
        return new String[]{
                ...
                "",
                Achievement.slashIf("<col=000080>Assignment</col>: Chop " + amount + " Magic logs from a Magic tree.", finished),
