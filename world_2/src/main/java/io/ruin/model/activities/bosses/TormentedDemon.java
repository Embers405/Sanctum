...
public class TormentedDemon extends NPCCombat {
    ...
    private static final Projectile RANGED_PROJECTILE = new Projectile(1302, 60, 31, 35, 35, 10, 0, 32);
    private static final int RANGED_HIT_GFX = 1303;
    private static final int RANGED_ANIM = 10867;
    ...
    private static final int MAGIC_ANIM = 10868;

    private static final int SWITCH_ANIM = 10866;

    private static final int MELEE_PRAYER = 14660;
    private static final int RANGED_PRAYER = 14662;
    private static final int MAGIC_PRAYER = 14661;
