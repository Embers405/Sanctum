...
public enum Fishing {
    ...
    private static final int PEARL_FISHING_ROD = 22846;
    ...
    private static void fish(Player player, Fishing fish) {
        ...
        if(!player.getInventory().hasId(FISHING_ROD) || !player.getInventory().hasId(PEARL_FISHING_ROD) || !player.getEquipment().hasId(PEARL_FISHING_ROD)) {
