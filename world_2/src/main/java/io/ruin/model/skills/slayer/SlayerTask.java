...
public class SlayerTask {
    ...
    @Expose public Type currentType;
        ...
        Server.afterData.add(() -> {
            ...
            TASKS.values().forEach(task -> {
                ...
                if(highest == Type.EASY) {
                    defaultMin = 10;
                    defaultMax = 25;
                } if(highest == Type.CRYSTAL) {
                        defaultMin = 11;
                        defaultMax = 80;

                } else if(highest == Type.WILDERNESS) {
                    defaultMin = 30;
                    defaultMax = 80;
                    ...
                    defaultMin = 50;
                    defaultMax = 115;
                } else if(highest == Type.KONAR) {
                    defaultMin = 45;
                    defaultMax = 100;
                } else if(highest == Type.WILDERNESSBOSS) {
                    defaultMin = 3;
                    defaultMax = 35;
                } else {
                    defaultMin = 3;
    ...
    /**
     * Has to stay in this order, Pulls from the .Json in what order the tasks come in
     * Meaning the first task type you see in the slayer_tasks.json is an EASY task
     * Second you would come across a WILDERNESS task
     */
    ...
    public enum Type {
        ...
        Type(int basePoints, int minimumCombatLevel) {
