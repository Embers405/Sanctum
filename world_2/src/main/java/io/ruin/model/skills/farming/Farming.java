...
public class Farming {
    ...
    @Expose private final ToolStorage storage = new ToolStorage();
    @Expose private CompostBin faladorCompostBin, canifisCompostBin, catherbyCompostBin, ardougneCompostBin, zeahCompostBin;
    @Expose private HerbPatch canifisHerb, ardougneHerb, faladorHerb, catherbyHerb, trollheimHerb, zeahHerb, guildHerb;
    @Expose private FlowerPatch faladorFlower, catherbyFlower, ardougneFlower, canifisFlower, zeahFlower, guildFlower;
    @Expose private AllotmentPatch faladorNorth, faladorSouth, catherbyNorth, catherbySouth, ardougneNorth, ardougneSouth, canifisNorth, canifisSouth, zeahNorth, zeahSouth, guildNorth, guildSouth;
    @Expose private WoodTreePatch lumbridgeTree, faladorTree, varrockTree, gnomeTree, taverleyTree, guildTree;
    @Expose private FruitTreePatch catherbyFruit, brimhavenFruit, gnomeFruit, villageFruit, lletyaFruit, guildFruit;
    @Expose private BushPatch varrockBush, ardougneBush, etceteriaBush, rimmingtonBush, guildBush;
    @Expose private HopsPatch lumbridgeHops, seersHops, yanilleHops, entranaHops;
    @Expose private CalquatTreePatch calquat;
    @Expose private CactusPatch cactus, guildCactus;
    @Expose private SpiritTreePatch brimhavenSpiritTree, etceteriaSpiritTree, portSarimSpiritTree, zeahSpiritTree, guildSpiritTree;
    @Expose private MushroomPatch canifisMushroom;
    @Expose private RedwoodTreePatch guildRedwood1, guildRedwood2, guildRedwood3, guildRedwood4, guildRedwood5, guildRedwood6, guildRedwood7, guildRedwood8, guildRedwood9;
    @Expose private CelastrusTreePatch guildCelastrus;
    @Expose private HesporiPatch guildHespori;
    @Expose private AnimaPatch guildAnima;
