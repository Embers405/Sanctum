...
public enum PatchData {
    ...
    GUILD_NORTH(33694, Config.FARMING_PATCH_3,0),
    GUILD_SOUTH(33693, Config.FARMING_PATCH_4,0),
    GUILD_SPIRIT(33733, "saplings", Config.FARMING_PATCH_1, 7),
    GUILD_TREE(33732, "saplings", Config.Guild_TREE_Patch, 2),
    GUILD_CELASTRUS(34629, "saplings", Config.GUILD_CELASTRUS_PATCH, 7),
    GUILD_FRUIT(34007, "saplings", Config.GUILD_FRUIT_PATCH, 3),
    GUILD_BUSH(34006,Config.FARMING_PATCH_2,4),
    GUILD_FLOWER(33649, Config.Guild_Flower_Patch, 5),
    GUILD_HERB(33979,Config.FARMING_COMPOST_BIN,6),
    GUILD_HESPORI(34630, Config.GUILD_HESPORI_PATCH, 7),
    GUILD_CACTUS(33761, Config.GUILD_CACTUS_PATCH, 7),
    ANIMA_PATCH(33998, Config.GUILD_ANIMA_PATCH,7),
    GUILD_REDWOOD_TREE_34051(34051, "saplings", Config.GUILD_REDWOOD_PATCH, 7),
    GUILD_REDWOOD_TREE_34052(34052, "saplings", Config.GUILD_REDWOOD_PATCH, 7),
    GUILD_REDWOOD_TREE_34053(34053, "saplings", Config.GUILD_REDWOOD_PATCH, 7),
    GUILD_REDWOOD_TREE_34054(34054, "saplings", Config.GUILD_REDWOOD_PATCH, 7),
    GUILD_REDWOOD_TREE_34055(34055, "saplings", Config.GUILD_REDWOOD_PATCH, 7),
    GUILD_REDWOOD_TREE_34056(34056, "saplings", Config.GUILD_REDWOOD_PATCH, 7),
    GUILD_REDWOOD_TREE_34057(34057, "saplings", Config.GUILD_REDWOOD_PATCH, 7),
    GUILD_REDWOOD_TREE_34058(34058, "saplings", Config.GUILD_REDWOOD_PATCH, 7),
    GUILD_REDWOOD_TREE_34059(34059, "saplings", Config.GUILD_REDWOOD_PATCH, 7)
