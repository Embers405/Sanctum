...
public class TargetSpell extends Spell {
    ...
    public void setBlightedSack(int id) {this.BlightedSack = id;}
    ...
    private boolean cast(Entity entity, Entity target, int projectileDuration, int maxDamage) {
        ...
        if(primaryCast) {
            ...
            if (entity.player != null) {
                ...
                if (runeItems != null && (r = RuneRemoval.get(entity.player, runeItems)) == null && !entity.player.getInventory().hasItem(BlightedSack, 1)) {
            ...
            if (BlightedSack != -1 && entity.player.getInventory().hasItem(BlightedSack, 1)) {
                entity.player.getInventory().remove(BlightedSack,1);
            } else if (r != null) {
                r.remove();
            }
        }
