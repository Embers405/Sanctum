...
public enum FishingArea {
    ...
    DONATOR_ZONE(
            new Position(2997, 2853, 0),
            new Position(2997, 2852, 0),
            new Position(2998, 2850, 0),
            new Position(2998, 2849, 0),
            new Position(2999, 2847, 0),
            new Position(3000, 2858, 0)
    ),
    LAVA_MAZE(
    ...
    static {
        try {
            ...
            LUMBRIDGE_TUTORIAL.add(FishingSpot.NET_BAIT, 12);
            LUMBRIDGE_RIVER.add(FishingSpot.LURE_BAIT, 8);
            DRAYNOR.add(FishingSpot.NET_BAIT, 4);
            BARBARIAN_VILLAGE.add(FishingSpot.LURE_BAIT, 5);
            CATHERBY.add(FishingSpot.NET_BAIT, 5);
            CATHERBY.add(FishingSpot.BIG_NET_HARPOON, 3);
            CATHERBY.add(FishingSpot.CAGE_HARPOON, 5);
            ...
            DONATOR_ZONE.add(FishingSpot.BIG_NET_HARPOON, 1);
            DONATOR_ZONE.add(FishingSpot.KARAMBWAN_SPOT, 1);
            DONATOR_ZONE.add(FishingSpot.CAGE_HARPOON, 1);
            DONATOR_ZONE.add(FishingSpot.SMALL_NET_HARPOON, 1);
