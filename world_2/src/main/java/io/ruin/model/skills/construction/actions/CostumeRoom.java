...
//            });
        ...
        ObjectAction.register(18805, "search", (player, obj) -> CostumeStorage.EASY_TREASURE_TRAILS.openTreasureChestBeginner(player));
        ...
        ObjectAction.register(18807, "search", (player, obj) -> player.dialogue(new OptionsDialogue(
                new Option("Beginner treasure trails", () -> CostumeStorage.BEGINNER_TREASURE_TRAILS.openTreasureChestBeginner(player)),
                new Option("Easy treasure trails", () -> CostumeStorage.EASY_TREASURE_TRAILS.openTreasureChestEasy(player)),
                new Option("Medium treasure trails", () -> CostumeStorage.MEDIUM_TREASURE_TRAILS.openTreasureChestMedium(player))
        )));
        ...
        ObjectAction.register(18809, "search", (player, obj) -> player.dialogue(new OptionsDialogue(
                ...
                new Option("Easy treasure trails", () -> CostumeStorage.EASY_TREASURE_TRAILS.openTreasureChestEasy(player)),
                new Option("Medium treasure trails", () -> CostumeStorage.MEDIUM_TREASURE_TRAILS.openTreasureChestMedium(player)),
                new Option("Hard treasure trails", () -> CostumeStorage.HARD_TREASURE_TRAILS_1.openTreasureChestHard(player)),
                new Option("Elite treasure trails", () -> CostumeStorage.ELITE_TREASURE_TRAILS.openTreasureChestElite(player)),
                new Option("Master treasure trails", () -> CostumeStorage.MASTER_TREASURE_TRAILS.openTreasureChestMaster(player))
        )));
