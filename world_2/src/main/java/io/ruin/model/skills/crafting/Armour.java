...
public enum Armour {
    ...
    LAVA_COIF(92, ArmourType.LAVA_DRAGONHIDE, 30261, "a lava dragonhide coif", 774.0, 2),
    LAVA_CHAPS(95, ArmourType.LAVA_DRAGONHIDE, 30263, "a pair of lava dragonhide chaps", 774.0, 3),
    LAVA_BODY(99, ArmourType.LAVA_DRAGONHIDE, 30262, "a lava dragonhide body", 774.0, 5),
    ...
    private static final int LAVA_DRAGON_LEATHER = 30264;
