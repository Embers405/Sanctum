    ...
    public void buyFromShop(Player player, Item requestedItem) {
        ...
        if(buyAmount > 0) {
            ...
            if (removedCurrency == requiredCurrency) {
                ...
                if (currency == Currency.PEST_CONTROL_POINTS || currency == Currency.MAGE_ARENA_POINTS || currency == Currency.GOLDEN_NUGGETS || currency == Currency.MARKS_OF_GRACE) {
