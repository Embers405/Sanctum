...
import io.ruin.model.skills.events.GlobalMethods;
...
public class Dwarf {
    ...
    public static void talkAboutSomethingElse(Player player, NPC npc) {
        player.dialogue(new OptionsDialogue( "What would you like to talk about?",
                new Option("What have you got in the Guild?", () -> whatHaveYouGot(player, npc)),
                new Option("What do you dwarves do with the ore you mine?", () -> whatDwarvesDo(player, npc)),
                new Option("No thanks, I'm fine.", () -> noThanks(player))
        ));
    ...
    public static void shootingStarsDialogue(Player player, NPC npc) {
        player.dialogue(new OptionsDialogue( "Something else",
                new Option("Exchange stardust", () -> GlobalMethods.exchangeCurrency(player, npc)))
        );
    }
    ...
    static {
        for (int id : DWARF_SET_ONE)
            NPCAction.register(id, "talk-to", (player, npc) -> player.dialogue(
                            ...
                            new OptionsDialogue(
                                    new Option("Shooting Stars", () -> shootingStarsDialogue(player, npc)),
                                    new Option("Something else", () -> talkAboutSomethingElse(player, npc)))
                    )
            );
