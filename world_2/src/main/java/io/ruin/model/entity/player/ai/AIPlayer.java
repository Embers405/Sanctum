...
import io.ruin.network.incoming.desktop.handlers.ActionButtonHandler;
import io.ruin.network.incoming.desktop.handlers.ObjectActionHandler;
...
public class AIPlayer extends Player {
    ...
    public void init() {
        ...
        info.update((25000 + count), info.name, "", ListUtils.toList(PlayerGroup.REGISTERED.id), 0);
        init(info);
