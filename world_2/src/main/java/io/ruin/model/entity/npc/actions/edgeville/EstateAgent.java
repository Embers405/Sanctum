...
public class EstateAgent {
    ...
    static {
        ...
        NPCAction.register(ESTATE_AGENT, "relocate", (p, npc) -> {
            p.dialogue(new NPCDialogue(npc, "Unfortunately changing the location of your house is currently unavailable."));
        });
        NPCAction.register(ESTATE_AGENT, "redecorate", (p, npc) -> selectStyle(p));
    }
