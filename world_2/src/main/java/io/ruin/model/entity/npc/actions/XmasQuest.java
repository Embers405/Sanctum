        ...
        NPCAction.register(1361, "talk-to", (player, npc) -> {
            if (PlayerCounter.SANTA.get(player) == 0) {
                player.dialogue(
                        ...
                        new NPCDialogue(npc, "Well, I was on my way to deliver presents to all of the lovely people of Obsidian, but my sleigh malfunctioned mid air and" +
                        ...
                        new NPCDialogue(npc, "I need you to collect presents during your adventures across Obsidian! You should be able to find them while doing any" +
