...
public class Title {
    ...
    public static final Title[] PRESET_TITLES = {
            prefixTitle("<col=0da8af><shad=000000><img=30>Owner </col></shad>").setPredicate(p -> p.isGroup(PlayerGroup.OWNER)).setHidden(),
            prefixTitle("<col=ffff00><shad=000000>Admin </col></shad>").setPredicate(p -> p.isGroup(PlayerGroup.ADMINISTRATOR)).setHidden(),
            prefixTitle("<col=a239db><shad=000000><img=31>Developer </shad></col>").setPredicate(p -> p.isGroup(PlayerGroup.DEVELOPER)).setHidden(),
            ...
            prefixTitle(colorAndShadow("bb7c00", "000000",  "Dragon ")).setPredicate(Player::isDragon).setHidden(),
            prefixTitle(colorAndShadow("0f0f0f", "000000",  "Rune ")).setPredicate(Player::isRune).setHidden(),
            prefixTitle(colorAndShadow("6600FF", "000000",  "Adamant ")).setPredicate(Player::isAdamant).setHidden(),
            prefixTitle(colorAndShadow("B9F2FF", "000000",  "Mithril ")).setPredicate(Player::isMithril).setHidden(),
            prefixTitle(colorAndShadow("9b111e", "000000",  "Gold ")).setPredicate(Player::isGold).setHidden(),
            prefixTitle(colorAndShadow("0f52ba", "000000",  "Bronze ")).setPredicate(Player::isBronze).setHidden(),
/*            prefixTitle(colorAndShadow("C2D61D", "000000", "Easy ")).setPredicate(p -> p.xpMode == XpMode.MEDIUM).setHidden(),
            prefixTitle(colorAndShadow("3544FD", "000000",  "Medium ")).setPredicate(p -> p.xpMode == XpMode.EASY).setHidden(),
...
/*            prefixTitle(colorAndShadow("9e9e9e", "000000", "Ironman ")).setPredicate(p -> p.getGameMode() == GameMode.IRONMAN).setHidden(),
            ...
            prefixTitle(colorAndShadow("13a5f9", "000000",  "Group Ironman ")).setPredicate(p -> p.getGameMode().isGroupIronman()).setHidden(),
            prefixTitle(colorAndShadow("bfbfbf", "000000",  "HCGroup Ironman ")).setPredicate(p -> p.getGameMode().isHardcoreGroupIronman()).setHidden(),*/
            prefixTitle(color("13a5f9", "EatSleepObsidian ")).setUnlockDescription(""),
            ...
            prefixTitle(colorAndShadow("5e2121", "00000", "GIM ")).setPredicate(p -> p.getGameMode() == GameMode.GROUP_IRONMAN).setUnlockDescription("Play as a Group Ironman"),
            prefixTitle(colorAndShadow("5e2121", "00000", "HCGIM ")).setPredicate(p -> p.getGameMode() == GameMode.HARDCORE_GROUP_IRONMAN).setUnlockDescription("Play as a Group Hardcore Ironman"),
