...
public final class Richard {
    ...
    public static final String SHOP_IDENTIFIER = "204b1cb6-f628-4f91-96c9-07941921a1e7";
    ...
    static {
                    ...
                    new OptionsDialogue(
                            new Option("What's so special about your capes?", () -> {
                                player.dialogue(
                                        ...
                                        new OptionsDialogue(
                                                new Option("Yes please!", () -> ShopManager.openIfExists(player, SHOP_IDENTIFIER)),
        ...
        NPCAction.register(RICHARD, "trade", (player, npc) -> ShopManager.openIfExists(player, SHOP_IDENTIFIER));
    }
}
