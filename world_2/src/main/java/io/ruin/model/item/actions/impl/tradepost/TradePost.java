...
public class TradePost {
    ...
    private static List<TradePostOffer> ads = new ArrayList<>();
...
//    }
    ...
    private void promptPrice(int itemId, int unnotedId, int amount) {
        player.integerInput("Enter price per item:", price -> {
            if (container().add(new TradePostOffer(String.valueOf(player.getUserId()), player.getName(), new Item(unnotedId, amount), price, System.currentTimeMillis()))) {
    ...
    private void buy(int index) {
        ...
        player.integerInput("Amount to Buy:", amount -> {
            ...
            if (offer.getUserId().equalsIgnoreCase(String.valueOf(player.getUserId()))) {
