...
public enum ItemUpgrading {
    ...
    VOID_TOP(8839, 13072, 3000, 15000000),
    VOID_BOTTOM(8840, 13073, 3000, 15000000),
    MAGIC_SHORT(861, 12788, 200, 5000000),
    SEERS_RING(6731, 11770, 2500, 7000000),
    ARCHERS_RING(6733, 11771, 2500, 7000000),
    WARRIOR_RING(6735, 11772, 1000, 7000000),
    BERSERKER_RING(6737, 11773, 1000, 7000000),
    SLAYER_HELMET(11864, 11865, 2000, 10000000),
    TYRANNICAL_RING(12603, 12691, 1500, 7000000),
    TREASONOUS_RING(12605, 12692, 1500, 7000000),
    RING_OF_THE_GODS(12601, 13202, 1500, 7000000),
    ...
    RING_OF_SUFFERING(19550, 19710, 2000, 7000000),
    RING_OF_SUFFERINGRI(20655, 20657, 2000, 14000000),
    GUTHIX_CAPE(2413, 21793, 5000, 5000000),
    ZAMORAK_CAPE(2414, 21795, 5000, 5000000),
    SARADOMIN_CAPE(2412, 21791, 5000, 5000000),
    SALVE_AMULET(4081, 12017, 5000, 10000000);
