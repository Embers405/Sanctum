...
public class VoteBox {
    ...
    public static final LootTable VOTE_BOX_TABLE = new LootTable().addTable(1,
            new LootItem(995, Random.get(50_000, 500_000), 70), //COINS CUNT
            new LootItem(995, Random.get(500_000, 1_000_000), 40), //COINS CUNT
            new LootItem(995, Random.get(500_000, 2_000_000), 30), //COINS CUNT
            new LootItem(995, Random.get(500_000, 3_000_000), 20), //COINS CUNT
            new LootItem(30256, 5, 15), //Vote Multipass
            new LootItem(6199, 1, 5), //Mystery Box
            new LootItem(290, 1, 3), //Super Mystery Box
            new LootItem(30250, 1, 2).broadcast(Broadcast.WORLD), //$10 bond
