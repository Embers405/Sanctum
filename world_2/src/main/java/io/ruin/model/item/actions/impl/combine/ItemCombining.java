...
public enum ItemCombining {
    ...
    //Crystal_body( 23975, 23776, 23845, true),
    ...
    DRAGON_HUNTER_CROSSBOW_T (21012, 2425, 25916, false),
    DRAGON_HUNTER_CROSSBOW_B (21012, 7980, 25918, false),
    SANGUINE_SCYTHE_OF_VITUR(22486,25746, 25741, false),
    zaryte_crossbow(11785, 30388, 30385, false),
    ANCIENT_GODSWORD(11798, 30386, 30387, false ),
    ...
    static {
        ...
        ItemItemAction.register(23975, 23776, (player, primary, secondary) -> {
            if (player.getInventory().count(secondary.getId()) < 5) {
                player.sendFilteredMessage("You don't have enough Blood crystal");
                return;
            }
            player.animate(713);
        ...
        ItemItemAction.register(22325, 25742, (player, primary, secondary) -> {
            if (player.getInventory().count(secondary.getId()) < 1) {
                player.sendFilteredMessage("You don't have enough Blood crystal");
                return;
            }
            player.animate(713);
        ...
        ItemItemAction.register(22481, 25744, (player, primary, secondary) -> {
            if (player.getInventory().count(secondary.getId()) < 1) {
                player.sendFilteredMessage("You don't have enough Blood crystal");
                return;
            }
        ...
        ItemItemAction.register(23979, 23776, (player, primary, secondary) -> {
            if (player.getInventory().count(secondary.getId()) < 5) {
                player.sendFilteredMessage("You don't have enough Blood crystal");
                return;
            }
        ...
        ItemItemAction.register(23971, 23776, (player, primary, secondary) -> {
            if (player.getInventory().count(secondary.getId()) < 3) {
                player.sendFilteredMessage("You don't have enough Blood crystal");
                return;
            }
            player.animate(713);
            player.getInventory().remove(secondary.getId(), 3);
            primary.setId(23842);
        });
