...
public class CollectionLog extends ItemContainerG<CollectionLogItem> {
    ...
    @Setter private int currentStruct;
    @Setter private int currentEntry;
...
/*    @Expose
  ...
  //      player.collection_log_current_entry = slot;
    ...
    /* adds cerberus' log items to collection log */
    public static void addLogItemnex(Player player) {
        player.getCollectionLog().collect(30000, 1);//hellpuppy
        player.getCollectionLog().collect(30001, 1);//eternal crystal
        player.getCollectionLog().collect(30002, 1);//pegasian crystal
        player.getCollectionLog().collect(30006, 1);//primordial crystal
        player.getCollectionLog().collect(30007, 1);//jar of souls
        player.getCollectionLog().collect(30008, 1);//smouldering stone
        player.getCollectionLog().collect(30003, 1);//key master teleport
        player.getCollectionLog().collect(30004, 1);//key master teleport
        player.getCollectionLog().collect(30005, 1);//key master teleport
        player.getCollectionLog().collect(30289, 1);//key master teleport
        player.getCollectionLog().collect(30367, 1);//key master teleport
        player.getCollectionLog().collect(30386, 1);//key master teleport
        player.getCollectionLog().collect(30388, 1);//key master teleport
    }

    /* adds cerberus' log items to collection log and to inventory */
    public static void addLogItemnexAndInventory(Player player) {
        CollectionLog.addLogItemCerberus(player);

        player.getInventory().add(30000, 1);//hellpuppy
        player.getInventory().add(30001, 1);//eternal crystal
        player.getInventory().add(30002, 1);//pegasian crystal
        player.getInventory().add(30006, 1);//primordial crystal
        player.getInventory().add(30007, 1);//jar of souls
        player.getInventory().add(30008, 1);//smouldering stone
        player.getInventory().add(30003, 1);//key master teleport
        player.getInventory().add(30004, 1);//key master teleport
        player.getInventory().add(30005, 1);//key master teleport
        player.getInventory().add(30289, 1);//key master teleport
        player.getInventory().add(30367, 1);//key master teleport
        player.getInventory().add(30386, 1);//key master teleport
        player.getInventory().add(30388, 1);//key master teleport
