...
public class ClanBox {
    ...
    public static void giveClanLeaderPrayers(Player player) {
        ...
        player.sendMessage("<col=8B0000>Your clan was given an Arcane prayer scroll & a Dexterous prayer scroll. Enjoy your time on RuneRogue!");
    ...
    public static void addClanBoxItems(Player player) {
        ...
        player.sendMessage("<col=8B0000>You are given a clan box and it's items are sent to your bank. Enjoy your time on RuneRogue!");
    }
