...
public class RepInter {
    ...
    public static void open(Player c) {
        OptionScroll.open(c, "<col=8B0000>RuneRogue Reputation",
                new Option(""),
    ...
    public static void displayEdge(Player c) {
        double percent = ((double)c.edgevilleRep / (double)c.maxEdgevilleRep) * 100;
        OptionScroll.open(c, "<col=8B0000>Edgeville Reputation - "+percent+"% complete",
                ...
                new Option("At each rank of reputation reached in Edgeville, you will receive"),
                ...
                new Option("rank at 4,000, 8,000, 12,000 and finally max at 15,000 rep in Edgeville."),
                new Option("----------------------------------------------------------")
        );
        return;
    }
    ...
    public static void displayFalador(Player c) {
        double percent = ((double)c.faladorRep / (double)c.maxFaladorRep) * 100;
    ...
    public static void displayKebos(Player c) {
        double percent = ((double)c.kebosRep / (double)c.maxKebosRep) * 100;
    ...
    public static void displayVarrock(Player c) {
        double percent = ((double)c.varrockRep / (double)c.maxVarrockRep) * 100;
