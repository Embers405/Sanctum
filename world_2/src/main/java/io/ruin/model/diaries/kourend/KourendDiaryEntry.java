...
public enum KourendDiaryEntry {
    ...
    CATACOMBS("Enter the Catacombs of Kourend."),
    MOLCH_ISLAND("Travel by boat to Molch Island."),
    ...
    STEAL_SILVER("Steal from the Silver Stall.", 50),
    DBONE_ALTAR("Use a Dragon Bone on the Altar."),
    ...
    CATCH_ANGLER("Catch a Anglerfish in Port Piscarilius."),
    SOUL_RUNE("Craft a Soul Rune."),
    KILL_ABYSSAL("Kill Abyssal Demons in the Catacombs.", 50),
    KILL_SKOTIZO("Kill Skotizo.", 5),
    KILL_VBOSS("Kill a Vote Boss."),
