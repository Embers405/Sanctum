...
public final class FremennikAchievementDiary extends StatefulAchievementDiary<FremennikDiaryEntry> {
    ...
    public final void display() {
        player.sendScroll("<col=8B0000>Fremennik Diary",
                ...
                hasCompletedAchieve("FFILL_BUCKET") ? "<col=24d124>Fill Buckets at the Rellekka well. (" +(getAbsoluteAchievementStage(FFILL_BUCKET)) + "/" + getMaximum(FFILL_BUCKET)+")</col>" : "<col=911c25>Fill Buckets at the Rellekka well. (" +(getAbsoluteAchievementStage(FFILL_BUCKET)) + "/" + getMaximum(FFILL_BUCKET)+ ")",
