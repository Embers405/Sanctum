...
public abstract class DifficultyAchievementDiary<T extends Enum<T>> extends AchievementDiary<T> {
    ...
    public final boolean claim(String difficulty, Player player) {
        return player.DiaryRewards.add(difficulty);
    }

    public final boolean hasClaimed(String difficulty, Player player) {
        return player.DiaryRewards.contains(difficulty);
    }
