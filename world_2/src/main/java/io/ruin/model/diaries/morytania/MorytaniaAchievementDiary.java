...
public final class MorytaniaAchievementDiary extends StatefulAchievementDiary<MorytaniaDiaryEntry> {
    ...
    public static final Set<MorytaniaDiaryEntry> EASY_TASKS = EnumSet.of(SBOTT, KILL_BANSHEE, KILL_GHOUL);
    ...
    public static final Set<MorytaniaDiaryEntry> ELITE_TASKS = EnumSet.of(BARROWS_CHEST, CRAFT_DHIDE, KILL_ABYSSAL_DEMON);
