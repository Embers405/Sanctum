package io.ruin.model.diaries.falador;
...
import static io.ruin.model.diaries.falador.FaladorDiaryEntry.*;
...
public final class FaladorAchievementDiary extends StatefulAchievementDiary<FaladorDiaryEntry> {
    ...
    public static final Set<FaladorDiaryEntry> EASY_TASKS = EnumSet.of(KILL_DUCK, WESTERN_WALL, FILL_BUCKET, REPAIR_STRUT, TRAVEL_ENTRANA, MIND_TIARA, FARMING_SHOP);

    public static final Set<FaladorDiaryEntry> MEDIUM_TASKS = EnumSet.of(CRYSTAL_CHEST, PICKPOCKET_GUARD, GOLD_ORE, NARROW_CREVICE, ALTAR_OF_GUTHIX, TELEPORT_FALADOR);

    public static final Set<FaladorDiaryEntry> HARD_TASKS = EnumSet.of(KILL_WYVERN, FALADOR_ROOFTOP, KILL_GIANT_MOLE, WARRIOR_GUILD);

    public static final Set<FaladorDiaryEntry> ELITE_TASKS = EnumSet.of(STRANGE_FLOOR, KILL_BLACK_DRAGON, WEAR_PROSPECTOR);
    ...
    public int getCount(int id) { return player.getInventory().count(id); }
