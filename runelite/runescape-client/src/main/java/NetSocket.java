				...
				if (var3 != 0) {
					...
					if (var3 != 0) {
						...
						for (var3 = 0; var3 < Players.Players_pendingUpdateCount; ++var3) {
							...
							//System.out.println("Player " + var5.username + " maskData="+var6+"("+Integer.toBinaryString(var6)+")");
							...
							if ((var6 & 8) != 0) {
								...
								//System.out.println("player " + (var5.username == null ? null : var5.username.name) + ", " + var5.targetIndex + " for " + var6 + " (" + Integer.toBinaryString(var6) + ")");
							}
								...
								if (var5.username != null && var5.appearance != null) {
									...
									if (!var13 && Client.field602 == 0 && !var5.isHidden) {
										...
										if (var16.modIcon != -1) {
											...
											SecureRandomCallable.addGameMessage(var15, var5.username.getName(), var14);//username.getName()
										}
									}
								}
