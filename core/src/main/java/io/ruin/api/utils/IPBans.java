...
public class IPBans {
    ...
    private static final File store = new File(System.getProperty("user.home") + "/Desktop/Obsidian/ip_bans.txt");
    ...
    private static void store(String user, String ip) {
        try (FileWriter fw = new FileWriter(store, true)) {
            ...
            pw.println(System.getProperty("line.separator") + user + " : " + ip);
