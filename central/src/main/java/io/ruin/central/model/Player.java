...
public class Player {
    ...
    private static File getSaveFile(String username, World world) throws IOException {
        File folder = new File(System.getProperty("user.home") + "/Desktop/Obsidian/_saved/players/" + world.stage.name().toLowerCase() + "/" + world.type.name().toLowerCase());
        ...
        return new File(System.getProperty("user.home") + "/Desktop/Obsidian/_saved/players/" + world.stage.name().toLowerCase() + "/" + world.type.name().toLowerCase() + "/" + username + ".json");
    }
}
